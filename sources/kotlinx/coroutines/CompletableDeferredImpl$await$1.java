...
@d(c = "kotlinx.coroutines.CompletableDeferredImpl", f = "CompletableDeferred.kt", i = {0}, l = {86}, m = "await", n = {"this"}, s = {"L$0"})
...
public final class CompletableDeferredImpl$await$1 extends ContinuationImpl {
    ...
    public CompletableDeferredImpl$await$1(CompletableDeferredImpl completableDeferredImpl, c cVar) {
        super(cVar);
