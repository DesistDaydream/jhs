...
@d(c = "kotlinx.coroutines.channels.ChannelsKt__Channels_commonKt$filter$1", f = "Channels.common.kt", i = {0, 1, 1, 2, 2}, l = {746, 747, 747}, m = "invokeSuspend", n = {"$this$produce", "$this$produce", e.a, "$this$produce", e.a}, s = {"L$0", "L$0", "L$1", "L$0", "L$1"})
...
public final class ChannelsKt__Channels_commonKt$filter$1 extends SuspendLambda implements p<w<? super E>, c<? super t1>, Object> {
    public final /* synthetic */ p $predicate;
    public final /* synthetic */ y $this_filter;
    public Object L$0;
    public Object L$1;
    public Object L$2;
    public int label;
    ...
    public ChannelsKt__Channels_commonKt$filter$1(y yVar, p pVar, c cVar) {
        super(2, cVar);
        this.$this_filter = yVar;
        this.$predicate = pVar;
    }
    ...
    public final c<t1> create(@k.e.a.e Object obj, @k.e.a.d c<?> cVar) {
        ChannelsKt__Channels_commonKt$filter$1 channelsKt__Channels_commonKt$filter$1 = new ChannelsKt__Channels_commonKt$filter$1(this.$this_filter, this.$predicate, cVar);
        channelsKt__Channels_commonKt$filter$1.p$ = (w) obj;
        return channelsKt__Channels_commonKt$filter$1;
    }

    @Override // h.k2.u.p
    public final Object invoke(Object obj, c<? super t1> cVar) {
        return ((ChannelsKt__Channels_commonKt$filter$1) create(obj, cVar)).invokeSuspend(t1.a);
    }
