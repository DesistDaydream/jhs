...
@d(c = "kotlinx.coroutines.flow.FlowKt__MergeKt$flatMapLatest$1", f = "Merge.kt", i = {0, 0, 1, 1, 1, 1}, l = {190, 216}, m = "invokeSuspend", n = {"$this$transformLatest", AdvanceSetting.NETWORK_TYPE, "$this$transformLatest", AdvanceSetting.NETWORK_TYPE, "$this$emitAll$iv", "flow$iv"}, s = {"L$0", "L$1", "L$0", "L$1", "L$2", "L$3"})
...
public final class FlowKt__MergeKt$flatMapLatest$1 extends SuspendLambda implements q<f<? super R>, T, c<? super t1>, Object> {
    ...
    public final c<t1> create(@k.e.a.d f<? super R> fVar, T t, @k.e.a.d c<? super t1> cVar) {
        ...
        flowKt__MergeKt$flatMapLatest$1.p$ = fVar;
    ...
    public final Object invoke(Object obj, Object obj2, c<? super t1> cVar) {
        return ((FlowKt__MergeKt$flatMapLatest$1) create((f) obj, obj2, cVar)).invokeSuspend(t1.a);
    }
    ...
    public final Object invokeSuspend$$forInline(@k.e.a.d Object obj) {
        ...
        c0.e(0);
        ((Flow) this.$transform.invoke(obj2, this)).e(fVar, this);
        c0.e(2);
        c0.e(1);
        return t1.a;
    }
