...
@d(c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6", f = "Zip.kt", i = {0}, l = {251}, m = "invokeSuspend", n = {"$this$flow"}, s = {"L$0"})
...
public final class FlowKt__ZipKt$combineTransform$6 extends SuspendLambda implements p<f<? super R>, c<? super t1>, Object> {
    ...
    @d(c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2", f = "Zip.kt", i = {0, 0}, l = {251}, m = "invokeSuspend", n = {"$this$combineInternal", AdvanceSetting.NETWORK_TYPE}, s = {"L$0", "L$1"})
    ...
    public FlowKt__ZipKt$combineTransform$6(Flow[] flowArr, q qVar, c cVar) {
        super(2, cVar);
        this.$flows = flowArr;
        this.$transform = qVar;
    }
    ...
    public final c<t1> create(@e Object obj, @k.e.a.d c<?> cVar) {
        ...
        flowKt__ZipKt$combineTransform$6.p$ = (f) obj;
        return flowKt__ZipKt$combineTransform$6;
    }

    @Override // h.k2.u.p
    public final Object invoke(Object obj, c<? super t1> cVar) {
        return ((FlowKt__ZipKt$combineTransform$6) create(obj, cVar)).invokeSuspend(t1.a);
    }
