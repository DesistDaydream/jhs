...
public class ReadApkFileUtil {
    ...
    public static String f3712d;

    /* renamed from: e  reason: collision with root package name */
    public static String f3713e;

    /* renamed from: f  reason: collision with root package name */
    public static String f3714f;
                ...
                while (a2 != null) {
                    if (a2.length() != 0) {
                        if (a2.startsWith("ApkHash:")) {
                            f3713e = a(a2.substring(a2.indexOf(Constants.COLON_SEPARATOR) + 1));
                        }
                        if (a2.startsWith(KEY_SIGNATURE)) {
                            b = a(a2.substring(a2.indexOf(Constants.COLON_SEPARATOR) + 1));
                            a2 = a(bufferedReader);
                        } else if (a2.startsWith(KEY_SIGNATURE2)) {
                            f3711c = a(a2.substring(a2.indexOf(Constants.COLON_SEPARATOR) + 1));
                            a2 = a(bufferedReader);
                        } else if (a2.startsWith(KEY_SIGNATURE3)) {
                            f3712d = a(a2.substring(a2.indexOf(Constants.COLON_SEPARATOR) + 1));
                            a2 = a(bufferedReader);
                        } else {
    ...
    public static boolean c() {
        ...
        if (a(Base64.decode(EMUI11_PK, 0), a(f3714f, "SHA-384"), b(f3712d), "SHA384withRSA")) {
    ...
    public static boolean b() {
        ...
        if (a(Base64.decode(EMUI10_PK, 0), a(f3714f, "SHA-256"), b(f3711c), "SHA256withRSA")) {
