...
public class Util {
    ...
    public static int getHmsVersion(Context context) {
        ...
        try {
            ...
            HMSLog.e(TAG, "In getHmsVersion, Failed to read meta data for the HMS VERSION.", e2);
            return 0;
        }
    }
            ...
            if (!availableInit) {
                ...
                if (packageManager == null) {
                    ...
                    try {
                        ...
                        HMSLog.e(TAG, "In isAvailableLibExist, Failed to read meta data for the availableLoaded.", e2);
                    }
                    isAvailableAvailable = z;
                    availableInit = true;
                }
    ...
    public static void unBindServiceCatchException(Context context, ServiceConnection serviceConnection) {
        try {
            ...
            HMSLog.e(TAG, "On unBindServiceException:" + e2.getMessage());
        }
    }
}
