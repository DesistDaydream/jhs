...
public class NetworkUtil {
    ...
    public static NetworkInfo getNetworkInfo(Context context) {
        ...
        try {
            ...
            String str = TAG;
            Logger.i(str, "getActiveNetworkInfo failed, exception:" + e2.getClass().getSimpleName() + e2.getMessage());
            return null;
        }
    }
        ...
        if (context != null) {
            ...
            if (systemService instanceof ConnectivityManager) {
                try {
                    ...
                    String str = TAG;
                    Logger.i(str, "getNetworkStatus exception" + e2.getClass().getSimpleName() + e2.getMessage());
                }
            } else {
        ...
        if (context != null) {
            ...
            if (systemService instanceof WifiManager) {
                try {
                    ...
                    String str = TAG;
                    Logger.i(str, "getWifiGatewayIp error!" + e2.getClass().getSimpleName() + e2.getMessage());
                    return ExpandableTextView.N;
                }
            }
            return ExpandableTextView.N;
        }
        ...
        if (context != null) {
            ...
            if (systemService instanceof WifiManager) {
                try {
                    ...
                    String str = TAG;
                    Logger.i(str, "getWifiRssiLevel did not has permission!" + e2.getClass().getSimpleName() + e2.getMessage());
                    return INVALID_RSSI;
                }
            }
            return INVALID_RSSI;
    ...
    public static boolean isUserUnlocked(Context context) {
        ...
        if (Build.VERSION.SDK_INT < 24 || (userManager = (UserManager) ContextCompat.getSystemService(context, UserKV.f3914d)) == null) {
            return true;
        }
        try {
