...
public abstract class a {
    ...
    public Map<String, String> f3472c = new ConcurrentHashMap(16);
    ...
    public Set<String> f3476g = new HashSet(16);
    ...
    private int g(String str) {
        ...
        return (!this.f3474e || !((list = this.b) == null || list.isEmpty()) || (c2 = c(str)) == 0) ? d(str) : c2;
    }
    ...
    public int a(String str, Context context) {
        ...
        sb.append(GrsApp.getInstance().getBrand(MqttTopic.TOPIC_LEVEL_SEPARATOR));
        sb.append(str);
    ...
    */
    ...
    public Map<String, String> a(Context context, com.huawei.hms.framework.network.grs.e.a aVar, GrsBaseInfo grsBaseInfo, String str, boolean z) {
        ...
        com.huawei.hms.framework.network.grs.local.model.d a3 = a.a(((a2 == null || a2.size() == 0) ? this.f3472c : a(a2, grsBaseInfo, b)).get(b));
        if (a3 == null) {
            return null;
        }
        return a3.a();
    ...
    public void a(Context context, List<String> list) {
        ...
        for (String str : list) {
            if (Pattern.matches("^grs_sdk_global_route_config_[a-zA-Z]+\\.json$", str)) {
                if (g(com.huawei.hms.framework.network.grs.h.c.a(GrsApp.getInstance().getBrand(MqttTopic.TOPIC_LEVEL_SEPARATOR) + str, context)) == 0) {
    ...
    public void a(GrsBaseInfo grsBaseInfo) {
        this.f3472c.put("no_route_country", "no-country");
        ...
        for (com.huawei.hms.framework.network.grs.local.model.b bVar : this.b) {
            if (bVar.a().contains(grsBaseInfo.getIssueCountry())) {
                this.f3472c.put(grsBaseInfo.getIssueCountry(), bVar.b());
            }
            if (bVar.a().contains(grsBaseInfo.getRegCountry())) {
                this.f3472c.put(grsBaseInfo.getRegCountry(), bVar.b());
            }
            if (bVar.a().contains(grsBaseInfo.getSerCountry())) {
                this.f3472c.put(grsBaseInfo.getSerCountry(), bVar.b());
            }
        }
        this.b = null;
    }
    ...
    */
    public void b(org.json.JSONArray r15) {
        ...
        Lc:
            ...
            r3.b(r4)
            java.util.Set<java.lang.String> r5 = r14.f3476g
            boolean r5 = r5.contains(r4)
            if (r5 != 0) goto Lf2
            java.util.Set<java.lang.String> r5 = r14.f3476g
            r5.add(r4)
            boolean r5 = r14.f3474e
            if (r5 == 0) goto Lf2
