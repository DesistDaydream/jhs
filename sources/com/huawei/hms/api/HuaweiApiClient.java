...
public abstract class HuaweiApiClient implements AidlApiClient {
    ...
    public static final class Builder {
        ...
        private final List<PermissionInfo> f3415c = new ArrayList();

        /* renamed from: d  reason: collision with root package name */
        private final Map<Api<?>, Api.ApiOptions> f3416d = new HashMap();

        /* renamed from: e  reason: collision with root package name */
        private OnConnectionFailedListener f3417e;

        /* renamed from: f  reason: collision with root package name */
        private ConnectionCallbacks f3418f;

        /* renamed from: g  reason: collision with root package name */
        private int f3419g;

        /* renamed from: h  reason: collision with root package name */
        private Activity f3420h;
        ...
        public Builder allowLifeCycleManagement(Activity activity, int i2, OnConnectionFailedListener onConnectionFailedListener) {
            if (i2 >= 0) {
                this.f3419g = i2;
                this.f3420h = (Activity) Preconditions.checkNotNull(activity, "activity must not be Null.");
                return this;
            }
        ...
        public HuaweiApiClient build() {
            ...
            huaweiApiClientImpl.setPermissionInfos(this.f3415c);
            huaweiApiClientImpl.setApiMap(this.f3416d);
            huaweiApiClientImpl.setConnectionCallbacks(this.f3418f);
            huaweiApiClientImpl.setConnectionFailedListener(this.f3417e);
            huaweiApiClientImpl.setAutoLifecycleClientId(this.f3419g);
            if (this.f3419g >= 0) {
        ...
        private void a(HuaweiApiClient huaweiApiClient) {
            AutoLifecycleFragment.getInstance(this.f3420h).startAutoMange(this.f3419g, huaweiApiClient);
        }
        ...
        public <O extends Api.ApiOptions.HasOptions> Builder addApiWithScope(Api<O> api, O o, Scope... scopeArr) {
            ...
            Checker.checkNonNull(scopeArr, "Scopes must not be null");
            this.f3416d.put(api, o);
            if (api.getOptions() != null) {
                this.b.addAll(api.getOptions().getScopeList(o));
                this.f3415c.addAll(api.getOptions().getPermissionInfoList(o));
            }
            this.b.addAll(new ArrayList(Arrays.asList(scopeArr)));
            return this;
        }
