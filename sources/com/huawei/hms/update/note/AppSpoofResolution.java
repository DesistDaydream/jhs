...
public class AppSpoofResolution implements IBridgeActivityDelegate {
    ...
    public class a implements AbstractDialog.Callback {
        ...
        public void onCancel(AbstractDialog abstractDialog) {
            com.huawei.hms.availableupdate.b.f3433c.a(true);
    ...
    public void onBridgeActivityCreate(Activity activity) {
        ...
        this.a = activity;
        com.huawei.hms.availableupdate.b bVar = com.huawei.hms.availableupdate.b.f3433c;
        bVar.a(activity);
        bVar.a(false);
        b();
    }
    ...
    public final void a() {
        ...
        if (com.huawei.hms.availableupdate.b.f3433c.a().compareAndSet(true, false)) {
            SystemManager.getInstance().notifyNoticeResult(29);
        }
        activity.finish();
    }
