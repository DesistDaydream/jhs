...
public class j {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:22:0x00ba, code lost:
        if (com.huawei.hms.push.q.a(r6.b, r6.f3661c.d(), r2).booleanValue() != false) goto L14;
     */
    ...
    */
    public final void b() {
        /*
            ...
            com.huawei.hms.push.k r2 = r6.f3661c     // Catch: java.lang.Exception -> Le1
            ...
            r3 = 0
            if (r2 == 0) goto L97
            com.huawei.hms.push.k r2 = r6.f3661c     // Catch: java.lang.Exception -> L7d
            ...
            com.huawei.hms.push.k r5 = r6.f3661c     // Catch: java.lang.Exception -> L7d
        ...
        L97:
            ...
            com.huawei.hms.push.k r4 = r6.f3661c     // Catch: java.lang.Exception -> Le1
            ...
            com.huawei.hms.push.k r5 = r6.f3661c     // Catch: java.lang.Exception -> Le1
    ...
    public void c() {
        ...
        if (this.b != null && (kVar = this.f3661c) != null) {
            if (PushConstants.EXTRA_APPLICATION_PENDING_INTENT.equals(kVar.i())) {
                a();
                return;
            } else if ("cosa".equals(this.f3661c.i())) {
                b();
                return;
            } else if ("rp".equals(this.f3661c.i())) {
                HMSLog.w("PushSelfShowLog", this.f3661c.i() + " not support rich message.");
                return;
            } else if ("url".equals(this.f3661c.i())) {
                HMSLog.w("PushSelfShowLog", this.f3661c.i() + " not support URL.");
                return;
            } else {
                HMSLog.d("PushSelfShowLog", this.f3661c.i() + " is not exist in hShowType");
                return;
            }
        }
    ...
    public final void a() {
        try {
            ...
            sb.append(this.f3661c.d());
            HMSLog.i("PushSelfShowLog", sb.toString());
            if (q.c(this.b, this.f3661c.d())) {
                b();
            }
        } catch (Exception e2) {
