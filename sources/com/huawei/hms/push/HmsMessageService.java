...
public class HmsMessageService extends Service {
    ...
    public void handleIntentMessage(Intent intent) {
        ...
        try {
            ...
            if ("new_token".equals(stringExtra2)) {
                ...
                b(stringExtra3, stringExtra, intent.getIntExtra(com.umeng.analytics.pro.d.O, ErrorEnum.ERROR_UNKNOWN.getInternalCode()));
            } else if ("delivery".equals(stringExtra2)) {
                int intExtra = intent.getIntExtra(com.umeng.analytics.pro.d.O, ErrorEnum.ERROR_APP_SERVER_NOT_ONLINE.getInternalCode());
    ...
    public final void a(Intent intent, String str) {
        ...
        int intExtra = intent.getIntExtra(com.umeng.analytics.pro.d.O, errorEnum.getInternalCode());
    ...
    public final synchronized void a(Intent intent, Bundle bundle, String str, int i2) {
        Context applicationContext = getApplicationContext();
