...
public class HmsMessaging {
    ...
    public HuaweiApi<Api.ApiOptions.NoOptions> f3639c;
    ...
    public final e.k.b.a.k<Void> a(String str, String str2) {
            ...
            try {
                ...
                if (a2 == ErrorEnum.SUCCESS) {
                    if (NetWorkUtil.getNetworkType(this.b) != 0) {
                        ...
                        if (s.b()) {
                            return this.f3639c.doWrite(new BaseVoidTask(PushNaming.SUBSCRIBE, JsonUtil.createJsonString(subscribeReq), reportEntry));
                        }
                        return this.f3639c.doWrite(new SubscribeTask(PushNaming.SUBSCRIBE, JsonUtil.createJsonString(subscribeReq), reportEntry));
                    }
                ...
                lVar.c(e2);
                PushBiUtil.reportExit(this.b, PushNaming.SUBSCRIBE, reportEntry, e2.getStatusCode());
                return lVar.b();
    ...
    public e.k.b.a.k<Void> subscribe(String str) {
        HMSLog.i("HmsMessaging", "invoke subscribe");
        return a(str, "Sub");
    }

    public e.k.b.a.k<Void> turnOffPush() {
        if (ProxyCenter.getProxy() != null) {
    ...
    public e.k.b.a.k<Void> turnOnPush() {
        if (ProxyCenter.getProxy() != null) {
    ...
    public e.k.b.a.k<Void> unsubscribe(String str) {
            ...
            if (!TextUtils.isEmpty(remoteMessage.getTo())) {
                if (!TextUtils.isEmpty(remoteMessage.getMessageId())) {
                    if (!TextUtils.isEmpty(remoteMessage.getData())) {
                        ...
                        if (s.b()) {
                            this.f3639c.doWrite(new BaseVoidTask(PushNaming.UPSEND_MSG, JsonUtil.createJsonString(upSendMsgReq), reportEntry));
                            return;
                        } else {
    ...
    public final e.k.b.a.k<Void> a(boolean z) {
        ...
        if (s.d(this.b) && !s.b()) {
            if (HwBuildEx.VERSION.EMUI_SDK_INT < 12) {
                ...
                Intent putExtra = new Intent("com.huawei.intent.action.SELF_SHOW_FLAG").putExtra("enalbeFlag", PushEncrypter.encrypterOld(context, this.b.getPackageName() + MqttTopic.MULTI_LEVEL_WILDCARD + z));
                putExtra.setPackage(Constants.ANDROID);
                return e.k.b.a.n.e(new IntentCallable(this.b, putExtra, reportEntry));
            } else {
                ...
                intent.setPackage(Constants.ANDROID);
                return e.k.b.a.n.e(new IntentCallable(this.b, intent, reportEntry));
            }
        }
        ...
        return this.f3639c.doWrite(new BaseVoidTask(PushNaming.SET_NOTIFY_FLAG, JsonUtil.createJsonString(enableNotifyReq), reportEntry));
    }

    public final void a(UpSendMsgReq upSendMsgReq, String str) {
        upSendMsgReq.setToken(BaseUtils.getLocalToken(this.b, null));
        try {
            this.f3639c.doWrite(new SendUpStreamTask(PushNaming.UPSEND_MSG, JsonUtil.createJsonString(upSendMsgReq), str, upSendMsgReq.getPackageName(), upSendMsgReq.getMessageId()));
        } catch (Exception e2) {
            if (e2.getCause() instanceof ApiException) {
                PushBiUtil.reportExit(this.b, PushNaming.UPSEND_MSG, str, ((ApiException) e2.getCause()).getStatusCode());
            } else {
