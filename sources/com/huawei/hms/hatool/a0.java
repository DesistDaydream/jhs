...
public abstract class a0 {
    ...
    public static b0 a(String str, byte[] bArr, Map<String, String> map, String str2) {
        ...
        int i2 = ErrCode.INNER_ERROR_TOKEN_NULL;
        ...
        try {
            try {
                ...
                try {
                    if (str == 0) {
                        b0 b0Var = new b0(ErrCode.INNER_ERROR_JSON, "");
                        t0.a((Closeable) null);
                        t0.a((Closeable) null);
                        if (str != 0) {
                    ...
                    try {
                        ...
                        b0 b0Var9 = new b0(ErrCode.INNER_ERROR_JSON, "");
                        t0.a((Closeable) bufferedOutputStream2);
                        t0.a((Closeable) map);
                        if (str != 0) {
                            t0.a((HttpURLConnection) str);
    ...
    public static HttpURLConnection a(String str, int i2, Map<String, String> map, String str2) {
        if (TextUtils.isEmpty(str)) {
    ...
    */
    public static void a(java.net.HttpURLConnection r3) {
        /*
            ...
            e.k.c.a.a.j.h r1 = e.k.c.a.a.j.h.e(r2)     // Catch: java.lang.IllegalAccessException -> L12 java.io.IOException -> L15 java.security.GeneralSecurityException -> L18 java.security.KeyStoreException -> L1b java.security.NoSuchAlgorithmException -> L1e
            goto L23
        L12:
        ...
        L23:
            ...
            e.k.c.a.a.j.p.b r0 = new e.k.c.a.a.j.p.b
            r0.<init>()
