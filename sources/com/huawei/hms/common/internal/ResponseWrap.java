...
public class ResponseWrap {
    ...
    public boolean fromJson(String str) {
        try {
            ...
            this.responseHeader.setStatusCode(JsonUtil.getIntValue(jSONObject, ReportItem.RequestKeyStatusCode));
    ...
    public String toJson() {
        ...
        try {
            jSONObject.put(ReportItem.RequestKeyStatusCode, this.responseHeader.getStatusCode());
