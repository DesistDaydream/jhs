...
public class FCMPushHelper {
    private static Map<String, String> a(Context context) {
        ...
        hashMap.put("actionType", String.valueOf(gq.AckMessage.a()));
        hashMap.put("deviceStatus", String.valueOf((int) ib.a(context, context.getPackageName())));
    ...
    private static void a(Context context, hn hnVar) {
        try {
            MiPushMessage generateMessage = PushMessageHelper.generateMessage((hu) ai.a(context, hnVar), hnVar.m(), false);
    ...
    */
    private static void a(android.content.Context r7, byte[] r8) {
        /*
            ...
            if (r1 == 0) goto L69
            if (r4 == 0) goto L69
            com.xiaomi.mipush.sdk.b r0 = com.xiaomi.mipush.sdk.b.m74a(r7)
            java.lang.String r0 = r0.d()
            byte[] r8 = com.xiaomi.push.service.cj.a(r8, r0)
            if (r8 != 0) goto L31
        ...
        L42:
            ...
            java.lang.String r4 = com.xiaomi.push.service.an.n
            r1.<init>(r4)
            r1.setPackage(r2)
        ...
        L87:
            ...
            com.xiaomi.push.hn r0 = com.xiaomi.push.service.cu.a(r8)
            com.xiaomi.push.service.n.a(r7, r0, r8)
        L95:
            return
        */
    ...
    private static boolean m44a(Context context) {
        return ((long) jc.c(context)) >= 50002000 && b(context);
    }
    ...
    public static void clearToken(Context context) {
        i.m95a(context, e.ASSEMBLE_PUSH_FCM);
    }
    ...
    public static boolean isFCMSwitchOpen(Context context) {
        return i.m98a(context, e.ASSEMBLE_PUSH_FCM) && MiPushClient.getOpenFCMPush(context);
    }
    ...
    public static void persistIfXmsfSupDecrypt(Context context) {
        context.getSharedPreferences("mipush_extra", 0).edit().putBoolean("is_xmsf_sup_decrypt", ((long) jc.c(context)) >= 50002000).apply();
    }
    ...
    public static void uploadToken(Context context, String str) {
        i.m96a(context, e.ASSEMBLE_PUSH_FCM, str);
    }
}
