        ...
        synchronized (af.class) {
            ...
            if (af.a(context).m53a(str)) {
                ...
                if (af.a(context2).a(str) < 10) {
                    ...
                    if (auVar2.ordinal() == i2) {
                        context10 = this.a.f26a;
                        if ("syncing".equals(af.a(context10).a(auVar2))) {
                            aoVar = this.a;
                            context11 = aoVar.f26a;
                            m93a = i.m93a(context11, e.ASSEMBLE_PUSH_HUAWEI);
                            aoVar.a(str, auVar2, false, m93a);
                            context13 = this.a.f26a;
                            af.a(context13).b(str);
                        }
                    }
                    ...
                    if (auVar2.ordinal() == i2) {
                        context8 = this.a.f26a;
                        if ("syncing".equals(af.a(context8).a(auVar2))) {
                            aoVar = this.a;
                            context9 = aoVar.f26a;
                            m93a = i.m93a(context9, e.ASSEMBLE_PUSH_FCM);
                            aoVar.a(str, auVar2, false, m93a);
                            context13 = this.a.f26a;
                            af.a(context13).b(str);
                        }
                    ...
                    if (auVar2.ordinal() == i2) {
                        context6 = this.a.f26a;
                        if ("syncing".equals(af.a(context6).a(auVar2))) {
                            aoVar = this.a;
                            context7 = aoVar.f26a;
                            m93a = i.m93a(context7, e.ASSEMBLE_PUSH_COS);
                            aoVar.a(str, auVar2, false, m93a);
                            context13 = this.a.f26a;
                            af.a(context13).b(str);
                        }
                    ...
                    if (auVar2.ordinal() == i2) {
                        context4 = this.a.f26a;
                        if ("syncing".equals(af.a(context4).a(auVar2))) {
                            aoVar = this.a;
                            context5 = aoVar.f26a;
                            m93a = i.m93a(context5, e.ASSEMBLE_PUSH_FTOS);
                            aoVar.a(str, auVar2, false, m93a);
                        }
                    }
                    context13 = this.a.f26a;
