...
public class hz implements ic<hz, Object>, Serializable, Cloneable {

    /* renamed from: i  reason: collision with root package name */
    private static final it f8963i = new it("XmPushActionUnSubscription");

    /* renamed from: j  reason: collision with root package name */
    private static final il f8964j = new il("", (byte) 11, 1);

    /* renamed from: k  reason: collision with root package name */
    private static final il f8965k = new il("", (byte) 12, 2);

    /* renamed from: l  reason: collision with root package name */
    private static final il f8966l = new il("", (byte) 11, 3);

    /* renamed from: m  reason: collision with root package name */
    private static final il f8967m = new il("", (byte) 11, 4);
        ...
        while (true) {
            ...
            switch (h2.f9004c) {
                ...
                case 8:
                    if (b == 15) {
                        im l2 = ioVar.l();
                        this.f8973h = new ArrayList(l2.b);
                        for (int i2 = 0; i2 < l2.b; i2++) {
                            this.f8973h.add(ioVar.v());
                        }
                        ioVar.m();
                        continue;
                        ioVar.i();
    ...
    public boolean a(hz hzVar) {
        ...
        boolean a = a();
        boolean a2 = hzVar.a();
        if ((a || a2) && !(a && a2 && this.a.equals(hzVar.a))) {
            return false;
        }
        boolean b = b();
        boolean b2 = hzVar.b();
        if ((b || b2) && !(b && b2 && this.b.a(hzVar.b))) {
            return false;
        }
        boolean c2 = c();
        boolean c3 = hzVar.c();
        if ((c2 || c3) && !(c2 && c3 && this.f8968c.equals(hzVar.f8968c))) {
            return false;
        }
        boolean d2 = d();
        boolean d3 = hzVar.d();
        if ((d2 || d3) && !(d2 && d3 && this.f8969d.equals(hzVar.f8969d))) {
            return false;
        }
        boolean e2 = e();
        boolean e3 = hzVar.e();
        if ((e2 || e3) && !(e2 && e3 && this.f8970e.equals(hzVar.f8970e))) {
            return false;
        }
        boolean f2 = f();
        boolean f3 = hzVar.f();
        if ((f2 || f3) && !(f2 && f3 && this.f8971f.equals(hzVar.f8971f))) {
            return false;
        }
        boolean g2 = g();
        boolean g3 = hzVar.g();
        if ((g2 || g3) && !(g2 && g3 && this.f8972g.equals(hzVar.f8972g))) {
            return false;
        }
        boolean h2 = h();
        boolean h3 = hzVar.h();
        if (h2 || h3) {
            return h2 && h3 && this.f8973h.equals(hzVar.f8973h);
        }
        return true;
    }
    ...
    public void b(io ioVar) {
        ...
        if (this.f8971f != null && f()) {
            ioVar.a(o);
            ioVar.a(this.f8971f);
            ioVar.b();
        }
        if (this.f8972g != null && g()) {
            ioVar.a(p);
            ioVar.a(this.f8972g);
            ioVar.b();
        }
        if (this.f8973h != null && h()) {
            ioVar.a(q);
            ioVar.a(new im((byte) 11, this.f8973h.size()));
            for (String str : this.f8973h) {
                ioVar.a(str);
            }
            ioVar.e();
            ioVar.b();
