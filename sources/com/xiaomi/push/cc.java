...
public abstract class cc {
    ...
    public static class a extends cb {
        ...
        public String b(Context context, String str, List<ak> list) {
            URL url;
            if (list == null) {
                url = new URL(str);
            } else {
    ...
    public static int a(int i2, int i3) {
        return (((i3 + 243) / 1448) * 132) + g0.b.f14277h + i2 + i3;
    }
    ...
    public static String a(Context context, String str, List<ak> list) {
    ...
    */
    public static java.lang.String a(android.content.Context r20, java.lang.String r21, java.util.List<com.xiaomi.push.ak> r22, com.xiaomi.push.cb r23, boolean r24) {
        /*
            r1 = r20
            r0 = r21
            r2 = r22
            r3 = r23
            boolean r4 = com.xiaomi.push.al.c(r20)
            r5 = 0
            if (r4 == 0) goto Lc7
            ...
            if (r24 == 0) goto L26
            com.xiaomi.push.by r6 = com.xiaomi.push.by.a()     // Catch: java.net.MalformedURLException -> Lc3
            com.xiaomi.push.bu r6 = r6.a(r0)     // Catch: java.net.MalformedURLException -> Lc3
            if (r6 == 0) goto L24
        ...
        L4c:
            ...
            boolean r0 = r3.a(r1, r14, r15)     // Catch: java.io.IOException -> La4
            if (r0 != 0) goto L58
            goto Lc2
        L58:
        ...
        Lc7:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.push.cc.a(android.content.Context, java.lang.String, java.util.List, com.xiaomi.push.cb, boolean):java.lang.String");
    }
}
