...
public class UMEnvelopeBuild {
    ...
    private static JSONObject add2CacheTable(Context context, JSONObject jSONObject, JSONObject jSONObject2, String str, String str2, String str3) {
        if (jSONObject != null && jSONObject2 != null) {
            ...
            contentValues.put(aq.f7041e, str2);
            contentValues.put(aq.f7042f, a.c(jSONObject.toString()));
            contentValues.put(aq.f7043g, a.c(jSONObject2.toString()));
            contentValues.put(aq.f7044h, String.valueOf(currentTimeMillis));
            contentValues.put(aq.f7045i, randomUUID.toString());
            contentValues.put(aq.f7046j, str);
            contentValues.put(aq.f7047k, str3);
            ao.a(context).a(aq.f7039c, contentValues);
            ...
            } else if (!am.ax.equalsIgnoreCase(str2)) {
                try {
                    if (am.aI.equalsIgnoreCase(str2)) {
    ...
    public static JSONObject buildEnvelopeWithExtHeader(Context context, JSONObject jSONObject, JSONObject jSONObject2) {
        ...
        if (jSONObject.has("st")) {
            ...
            str = jSONObject2.has("inner") ? "i" : am.av;
        }
        return buildEnvelopeWithExtHeader(context, jSONObject, jSONObject2, UMServerURL.PATH_ANALYTICS, str, "9.5.2");
    }
