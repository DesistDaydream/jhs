...
public class UMProcessDBDatasSender implements UMLogDataProtocol {
    ...
    public class ReplaceCallback implements FileLockCallback {
        ...
        public boolean onFileLock(String str) {
            ...
            if (str.startsWith(a.f7294c)) {
                str = str.replaceFirst(a.f7294c, "");
            }
            UMProcessDBHelper.getInstance(UMProcessDBDatasSender.this.mContext).deleteEventDatas(str.replace(a.f7295d, ""), null, null);
            return true;
        }
    ...
    private int defconProcesserHandler() {
        ...
        if (a != 0) {
            ...
            UMProcessDBHelper.getInstance(this.mContext).deleteEventDatas(a.f7299h, null, null);
        }
        return a;
    }
    ...
    private JSONObject generalHeader() {
        ...
        try {
            ...
            jSONObject.put(d.f7137i, AnalyticsConfig.getVerticalType(this.mContext));
            String str3 = "9.5.2";
            ...
            SharedPreferences sharedPreferences = PreferenceWrapper.getDefault(this.mContext);
            jSONObject.put(d.f7140l, UMEnvelopeBuild.imprintProperty(this.mContext, "pr_ve", null));
            jSONObject.put(d.f7141m, UMEnvelopeBuild.imprintProperty(this.mContext, "ud_da", null));
            jSONObject.put(d.ah, "1.0.0");
            if (TextUtils.isEmpty(imprintProperty)) {
                jSONObject.put(d.f7140l, sharedPreferences.getString("vers_pre_version", "0"));
                jSONObject.put(d.f7141m, sharedPreferences.getString("vers_date", new SimpleDateFormat(b0.a.b, Locale.getDefault()).format(new Date(System.currentTimeMillis()))));
            }
        } catch (Throwable th) {
            th.printStackTrace();
        }
