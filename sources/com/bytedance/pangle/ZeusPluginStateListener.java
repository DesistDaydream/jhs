        ...
        mHandler.post(new Runnable() { // from class: com.bytedance.pangle.ZeusPluginStateListener.1
            ...
            public final void run() {
                ...
                for (ZeusPluginStateListener zeusPluginStateListener : list) {
                    zeusPluginStateListener.onPluginStateChange(TextUtils.isEmpty(str) ? GrsBaseInfo.CountryCodeSource.UNKNOWN : str, i2, objArr);
                }
            }
        });
    }

    public abstract void onPluginStateChange(String str, int i2, Object... objArr);
}
