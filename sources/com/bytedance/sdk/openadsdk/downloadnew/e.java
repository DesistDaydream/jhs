    ...
    public <T> T callMethod(Class<T> cls, int i2, Map<String, Object> map) {
        switch (i2) {
            ...
            case 12:
                ...
                if (a(g2)) {
                    return (T) Boolean.valueOf(d.a(this.b, uri, b2, c2, d2, g2));
                }
                return (T) Boolean.valueOf(d.a(this.b, uri, b2, c2, d2));
            case 13:
                ...
                DownloadEventConfig c3 = c(map.get(TTDownloadField.TT_DOWNLOAD_EVENT_CONFIG));
                DownloadController d3 = d(map.get(TTDownloadField.TT_DOWNLOAD_CONTROLLER));
                DownloadStatusChangeListener a2 = a(map.get(TTDownloadField.TT_DOWNLOAD_STATUSCHANGE_LISTENER));
                IDownloadButtonClickListener g3 = g(map.get(TTDownloadField.TT_DOWNLOAD_BUTTON_CLICK_LISTENER));
                if (a(g3)) {
                    d.a().e().a(this.b, str, booleanValue2, b3, c3, d3, a2, intValue3, g3);
                    return null;
                }
                d.a().e().a(this.b, str, booleanValue2, b3, c3, d3, a2, intValue3);
                return null;
            case 14:
            ...
            case 17:
                ...
                return null;
            case 18:
                return (T) Boolean.valueOf(d.a().e().a(((Long) map.get("id")).longValue(), ((Integer) map.get(TTDownloadField.TT_HASHCODE)).intValue()));
            case 19:
                return (T) Boolean.valueOf(d.a().e().a(((Long) map.get("id")).longValue()));
        }
    }
