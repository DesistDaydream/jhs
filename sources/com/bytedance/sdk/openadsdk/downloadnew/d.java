...
public class d {
    ...
    /* renamed from: c */
    public static ITTDownloadVisitor f2451c;

    /* renamed from: e */
    private static Context f2453e;

    /* renamed from: f */
    private static Map<Integer, ITTDownloadAdapter.OnEventLogHandler> f2454f;

    /* renamed from: g */
    private static final com.ss.android.download.api.download.a.a f2455g;

    /* renamed from: d */
    private static final AtomicBoolean f2452d = new AtomicBoolean(false);
    ...
    static {
        ...
        f2455g = new com.ss.android.download.api.download.a.a() { // from class: com.bytedance.sdk.openadsdk.downloadnew.d.6
    ...
    public static ITTDownloadVisitor e() {
        ITTDownloadVisitor iTTDownloadVisitor = f2451c;
    ...
    public static class a implements com.ss.android.download.api.config.f {
        private void c(com.ss.android.download.api.model.c cVar) {
            ...
            Object l2 = cVar.l();
            TTDownloadEventModel label = TTDownloadEventModel.builder().setTag(cVar.b()).setExtJson(cVar.h()).setMaterialMeta(l2 instanceof JSONObject ? (JSONObject) l2 : null).setLabel(cVar.c());
    ...
    public static void a(Context context) {
        ...
        AtomicBoolean atomicBoolean = f2452d;
        if (atomicBoolean.get()) {
            return;
        }
        synchronized (d.class) {
            if (!atomicBoolean.get()) {
                f2453e = context.getApplicationContext();
                if (e() != null) {
    ...
    /* renamed from: com.bytedance.sdk.openadsdk.downloadnew.d$d */
    /* loaded from: classes.dex */
    public static class C0090d implements k {
        ...
        private DialogBuilder c(final com.ss.android.download.api.model.b bVar) {
            return DialogBuilder.builder().setTitle(bVar.b).setMessage(bVar.f5136c).setNegativeBtnText(bVar.f5138e).setPositiveBtnText(bVar.f5137d).setIcon(bVar.f5140g).setDialogStatusChangedListener(new IDialogStatusChangedListener() { // from class: com.bytedance.sdk.openadsdk.downloadnew.d.d.1
                {
                    C0090d.this = this;
                }
                ...
                public void onCancel(DialogInterface dialogInterface) {
                    b.InterfaceC0170b interfaceC0170b = bVar.f5141h;
        ...
        public void a(int i2, Context context, DownloadModel downloadModel, String str, Drawable drawable, int i3) {
            try {
                ...
                com.ss.android.socialbase.downloader.c.a.e("LibUIFactory", "showToastWithDuration e " + e2.getMessage());
            }
        }
        ...
        public AlertDialog b(com.ss.android.download.api.model.b bVar) {
            if (bVar != null && d.e() != null) {
                ...
                if (context != null && (context instanceof Activity)) {
                    return d.e().showDialogBySelf((Activity) bVar.a, bVar.f5143j == 1, c(bVar));
                }
                d.e().showDialogByDelegate(this.a, bVar.f5143j == 1, c(bVar));
            }
            return null;
        }
    }
    ...
    private static boolean b(Context context) {
        ...
        com.ss.android.download.api.a a3 = a2.a(new c()).a(new a()).a(new C0090d(applicationContext)).a(new b()).a(new com.ss.android.download.api.config.i() { // from class: com.bytedance.sdk.openadsdk.downloadnew.d.3
        ...
        }).a(new a.C0169a().b("143").a(TTAdConstant.APP_NAME).c("4.8.0.8").d(String.valueOf(4808)).a()).a(new p() { // from class: com.bytedance.sdk.openadsdk.downloadnew.d.1
        ...
        com.ss.android.downloadlib.g.a(applicationContext).a(f2455g);
    ...
    public static void a(int i2) {
        Map<Integer, ITTDownloadAdapter.OnEventLogHandler> map = f2454f;
        if (map != null) {
    ...
    public static void a(int i2, ITTDownloadAdapter.OnEventLogHandler onEventLogHandler) {
        if (onEventLogHandler != null) {
            if (f2454f == null) {
                f2454f = Collections.synchronizedMap(new WeakHashMap());
            }
            f2454f.put(Integer.valueOf(i2), onEventLogHandler);
        }
    }
    ...
    public static boolean a(Activity activity, final ExitInstallListener exitInstallListener) {
        return com.ss.android.downloadlib.addownload.a.a.a().a(activity, false, new a.InterfaceC0175a() { // from class: com.bytedance.sdk.openadsdk.downloadnew.d.7
            @Override // com.ss.android.downloadlib.addownload.a.a.InterfaceC0175a
            public void a() {
