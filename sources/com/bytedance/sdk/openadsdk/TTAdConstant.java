...
public class TTAdConstant {
    ...
    public static final String BRANCH = "v4800_ccr_mssdk_roll_back";
    public static final int BUILD_IN_MODULE_VERSION_CODE = 4808;
    public static final String BUILD_IN_MODULE_VERSION_NAME = "4.8.0.8";
    ...
    public static final String C_H = "db8aec4";
    ...
    public static final int SDK_VERSION_CODE = 4808;
    public static final String SDK_VERSION_NAME = "4.8.0.8";
