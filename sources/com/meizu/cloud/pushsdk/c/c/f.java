...
public class f {
    ...
    private final List<String> f4734g;

    /* renamed from: h  reason: collision with root package name */
    private final List<String> f4735h;
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            a = iArr;
            try {
                iArr[a.EnumC0157a.SUCCESS.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                a[a.EnumC0157a.INVALID_HOST.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                a[a.EnumC0157a.UNSUPPORTED_SCHEME.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                a[a.EnumC0157a.MISSING_SCHEME.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                a[a.EnumC0157a.INVALID_PORT.ordinal()] = 5;
    ...
    public static final class a {
        ...
        /* renamed from: f  reason: collision with root package name */
        public final List<String> f4741f;

        /* renamed from: g  reason: collision with root package name */
        public List<String> f4742g;
        ...
        */
        private void a(java.lang.String r11, int r12, int r13) {
            ...
            L3:
                ...
                goto L1e
            L13:
                java.util.List<java.lang.String> r0 = r10.f4741f
                int r1 = r0.size()
                int r1 = r1 - r3
                r0.set(r1, r2)
                goto L29
        ...
        private void a(String str, int i2, int i3, boolean z, boolean z2) {
            String b = f.b(str, i2, i3, HttpUrl.PATH_SEGMENT_ENCODE_SET, z2, false, false, true);
            if (b(b)) {
                return;
            }
            if (c(b)) {
            ...
            List<String> list = this.f4741f;
            if (list.get(list.size() - 1).isEmpty()) {
                List<String> list2 = this.f4741f;
        ...
        private void c() {
            List<String> list = this.f4741f;
            if (!list.remove(list.size() - 1).isEmpty() || this.f4741f.isEmpty()) {
                this.f4741f.add("");
                return;
            }
            List<String> list2 = this.f4741f;
        ...
        private static String e(String str, int i2, int i3) {
            String b = f.b(str, i2, i3, false);
            if (b.contains(Constants.COLON_SEPARATOR)) {
                InetAddress f2 = (b.startsWith("[") && b.endsWith("]")) ? f(b, 1, b.length() - 1) : f(b, 0, b.length());
                if (f2 == null) {
                    return null;
                }
        ...
        */
        ...
        public EnumC0157a a(f fVar, String str) {
            int a;
            int i2;
            ...
            if (b(str, a2, b) != -1) {
                if (str.regionMatches(true, a2, "https:", 0, 6)) {
                    ...
                    return EnumC0157a.UNSUPPORTED_SCHEME;
                } else {
                    this.a = "http";
                    a2 += 5;
                }
            } else if (fVar == null) {
                return EnumC0157a.MISSING_SCHEME;
            } else {
                this.a = fVar.b;
            }
            int c2 = c(str, a2, b);
            ...
            if (c2 >= 2 || fVar == null || !fVar.b.equals(this.a)) {
                ...
                while (true) {
                    ...
                    if (charAt == '@') {
                        if (z) {
                            i2 = a;
                            this.f4738c += "%40" + f.b(str, i3, i2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true);
                        } else {
                            int a3 = m.a(str, i3, a, ':');
                            i2 = a;
                            String b2 = f.b(str, i3, a3, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true);
                            if (z2) {
                                b2 = this.b + "%40" + b2;
                            }
                            this.b = b2;
                            if (a3 != i2) {
                                this.f4738c = f.b(str, a3 + 1, i2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true);
                                z = true;
                            }
                            z2 = true;
                        }
                ...
                int d2 = d(str, i3, a);
                int i4 = d2 + 1;
                this.f4739d = e(str, i3, d2);
                if (i4 < a) {
                    int g2 = g(str, i4, a);
                    this.f4740e = g2;
                    if (g2 == -1) {
                        return EnumC0157a.INVALID_PORT;
                    }
                } else {
                    this.f4740e = f.a(this.a);
                }
                if (this.f4739d == null) {
                    return EnumC0157a.INVALID_HOST;
                }
                a2 = a;
            } else {
                this.b = fVar.a();
                this.f4738c = fVar.b();
                this.f4739d = fVar.f4732e;
                this.f4740e = fVar.f4733f;
                this.f4741f.clear();
                this.f4741f.addAll(fVar.c());
            ...
            if (a4 < b && str.charAt(a4) == '?') {
                int a5 = m.a(str, a4, b, '#');
                this.f4742g = f.b(f.b(str, a4 + 1, a5, HttpUrl.QUERY_ENCODE_SET, true, false, true, true));
                a4 = a5;
            }
            if (a4 < b && str.charAt(a4) == '#') {
                this.f4743h = f.b(str, 1 + a4, b, "", true, false, false, false);
            }
            return EnumC0157a.SUCCESS;
        }

        public a a(String str) {
            this.f4742g = str != null ? f.b(f.a(str, HttpUrl.QUERY_ENCODE_SET, true, false, true, true)) : null;
            return this;
        }
        ...
        public a a(String str, String str2) {
            if (str != null) {
                ...
                this.f4742g.add(f.a(str, HttpUrl.QUERY_COMPONENT_REENCODE_SET, false, false, true, true));
                this.f4742g.add(str2 != null ? f.a(str2, HttpUrl.QUERY_COMPONENT_REENCODE_SET, false, false, true, true) : null);
                return this;
            }
        ...
        public String toString() {
            ...
            sb.append(this.a);
            sb.append("://");
            if (!this.b.isEmpty() || !this.f4738c.isEmpty()) {
                sb.append(this.b);
    ...
    private f(a aVar) {
        this.b = aVar.a;
        this.f4730c = a(aVar.b, false);
        this.f4731d = a(aVar.f4738c, false);
        this.f4732e = aVar.f4739d;
        this.f4733f = aVar.a();
        this.f4734g = a(aVar.f4741f, false);
        List<String> list = aVar.f4742g;
        this.f4735h = list != null ? a(list, true) : null;
        String str = aVar.f4743h;
        this.f4736i = str != null ? a(str, false) : null;
        this.f4737j = aVar.toString();
    }
    ...
    private static void a(com.meizu.cloud.pushsdk.c.g.b bVar, String str, int i2, int i3, String str2, boolean z, boolean z2, boolean z3, boolean z4) {
    ...
    public static f c(String str) {
        a aVar = new a();
        if (aVar.a((f) null, str) == a.EnumC0157a.SUCCESS) {
            return aVar.b();
        }
        return null;
    }
    ...
    public String a() {
        ...
        return this.f4737j.substring(length, m.a(str, length, str.length(), ":@"));
    }
    ...
    public String b() {
        ...
        int indexOf = this.f4737j.indexOf(64);
        return this.f4737j.substring(this.f4737j.indexOf(58, this.b.length() + 3) + 1, indexOf);
    }

    public List<String> c() {
        int indexOf = this.f4737j.indexOf(47, this.b.length() + 3);
        String str = this.f4737j;
        int a2 = m.a(str, indexOf, str.length(), "?#");
        ArrayList arrayList = new ArrayList();
        while (indexOf < a2) {
            int i2 = indexOf + 1;
            int a3 = m.a(this.f4737j, i2, a2, (char) Attributes.InternalPrefix);
            arrayList.add(this.f4737j.substring(i2, a3));
            indexOf = a3;
        }
        return arrayList;
    }
    ...
    public String d() {
        ...
        int indexOf = this.f4737j.indexOf(63) + 1;
        String str = this.f4737j;
        return this.f4737j.substring(indexOf, m.a(str, indexOf + 1, str.length(), '#'));
    }
    ...
    public String e() {
        ...
        return this.f4737j.substring(this.f4737j.indexOf(35) + 1);
    }

    public boolean equals(Object obj) {
        return (obj instanceof f) && ((f) obj).f4737j.equals(this.f4737j);
    }
    ...
    public a f() {
        ...
        aVar.b = a();
        aVar.f4738c = b();
        aVar.f4739d = this.f4732e;
        aVar.f4740e = this.f4733f != a(this.b) ? this.f4733f : -1;
        aVar.f4741f.clear();
        aVar.f4741f.addAll(c());
        aVar.a(d());
        aVar.f4743h = e();
        return aVar;
    }
