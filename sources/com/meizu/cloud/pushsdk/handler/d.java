...
public class d {
    public static MessageV3 a(String str) {
        String str2;
        MessageV3 messageV3;
        e.p.a.a.a.c("MessageSerialize", "message serialize stringToMessageV3 start, msgText=" + str);
        try {
        ...
        try {
            e.p.a.a.a.c(str2, "message serialize stringToMessageV3 success, messageV3=" + messageV3);
            return messageV3;
        } catch (JSONException e4) {
            e = e4;
            e.p.a.a.a.f(str2, "message serialize stringToMessageV3 error， " + e.getMessage());
            e.printStackTrace();
            return null;
        }
    }
    ...
    public static String a(MessageV3 messageV3) {
        e.p.a.a.a.c("MessageSerialize", "message serialize messageV3ToString start, messageV3=" + messageV3);
        try {
            ...
            e.p.a.a.a.c("MessageSerialize", "message serialize messageV3ToString success, msgText=" + jSONObject2);
            return jSONObject2;
        } catch (JSONException e2) {
            e.p.a.a.a.f("MessageSerialize", "message serialize messageV3ToString error, " + e2.getMessage());
            e2.printStackTrace();
            return null;
        }
    }
