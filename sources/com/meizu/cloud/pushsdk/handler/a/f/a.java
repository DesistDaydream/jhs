...
public class a {
    ...
    private void a(final Intent intent) {
        com.meizu.cloud.pushsdk.b.c.c.a().execute(new Runnable() { // from class: com.meizu.cloud.pushsdk.handler.a.f.a.1
            ...
            public void run() {
                try {
                    Thread.sleep(1000L);
                    e.p.a.a.a.e("BrightNotification", "start bright notification service " + intent);
                    a.this.a.startService(intent);
                } catch (Exception e2) {
                    e.p.a.a.a.f("BrightNotification", "send bright notification error " + e2.getMessage());
                }
            }
        });
    }
    ...
    private void b() {
        ...
        if (this.f4915c == null) {
            this.f4915c = new BroadcastReceiver() { // from class: com.meizu.cloud.pushsdk.handler.a.f.a.2
        ...
        this.a.registerReceiver(this.f4915c, intentFilter);
    }
    ...
    public void a(Intent intent, String str) {
        ...
        this.b.add(intent);
        e.p.a.a.a.e("BrightNotification", "add bright notification intent, intent list: " + this.b);
    }
}
