...
public class b extends com.meizu.cloud.pushsdk.handler.a.a<MessageV3> {
    ...
    private Intent b(Context context, MessageV3 messageV3) {
        ...
        e.p.a.a.a.c("AbstractMessageHandler", "openClassName is " + uriPackageName);
        if (messageV3.getClickType() == 0) {
            ...
            if (intent != null && messageV3.getParamsMap() != null) {
                for (Map.Entry<String, String> entry : messageV3.getParamsMap().entrySet()) {
                    e.p.a.a.a.c("AbstractMessageHandler", " launcher activity key " + entry.getKey() + " value " + entry.getValue());
            ...
            if (messageV3.getParamsMap() != null) {
                for (Map.Entry<String, String> entry2 : messageV3.getParamsMap().entrySet()) {
                    e.p.a.a.a.c("AbstractMessageHandler", " key " + entry2.getKey() + " value " + entry2.getValue());
            ...
            e.p.a.a.a.c("AbstractMessageHandler", intent.toUri(1));
            ...
            if (!TextUtils.isEmpty(uriPackageName2)) {
                ...
                e.p.a.a.a.c("AbstractMessageHandler", "set uri package " + uriPackageName2);
            }
            intent = intent2;
        } else {
            if (3 == messageV3.getClickType()) {
                e.p.a.a.a.c("AbstractMessageHandler", "CLICK_TYPE_SELF_DEFINE_ACTION");
            }
            intent = null;
        }
        if (intent != null) {
    ...
    private void e(MessageV3 messageV3) {
        ...
        if (b != null) {
            ...
            try {
                ...
                e.p.a.a.a.f("AbstractMessageHandler", "Click message StartActivity error " + e2.getMessage());
            }
        }
    }
    ...
    private MessageV3 m(Intent intent) {
        ...
        try {
            try {
                ...
                e.p.a.a.a.f("AbstractMessageHandler", "cannot get messageV3");
            }
            return MessageV3.parse(g2, d2, taskId, mPushMessage);
        } finally {
            e.p.a.a.a.f("AbstractMessageHandler", "parse MessageV2 to MessageV3");
    ...
    public boolean a(Intent intent) {
        e.p.a.a.a.c("AbstractMessageHandler", "start NotificationClickMessageHandler match");
    ...
    public MessageV3 c(Intent intent) {
        e.p.a.a.a.f("AbstractMessageHandler", "parse message V3");
