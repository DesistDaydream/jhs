...
public class e extends com.meizu.cloud.pushsdk.handler.a.a<com.meizu.cloud.pushsdk.handler.a.c.c> {
    ...
    public void b(com.meizu.cloud.pushsdk.handler.a.c.c cVar) {
        int c2 = cVar.c();
        if (c2 == -2) {
            e.p.a.a.a.f("AbstractMessageHandler", "notification STATE_NOTIFICATION_SHOW_ACCESS_DENY");
            ...
            e.p.a.a.a.f("AbstractMessageHandler", "notification STATE_NOTIFICATION_SHOW_INBOX");
            ...
            e.p.a.a.a.f("AbstractMessageHandler", "notification STATE_NOTIFICATION_SHOW_NORMAL");
            ...
            e.p.a.a.a.f("AbstractMessageHandler", "notification STATE_NOTIFICATION_SHOW_FLOAT");
    ...
    public void a(com.meizu.cloud.pushsdk.handler.a.c.c cVar, com.meizu.cloud.pushsdk.notification.c cVar2) {
        e.p.a.a.a.f("AbstractMessageHandler", "store notification id " + cVar.b());
        com.meizu.cloud.pushsdk.notification.c.b.b(d(), cVar.a().getUploadDataPackageName(), cVar.b());
    }

    @Override // com.meizu.cloud.pushsdk.handler.c
    public boolean a(Intent intent) {
        e.p.a.a.a.c("AbstractMessageHandler", "start NotificationStateMessageHandler match");
    ...
    public com.meizu.cloud.pushsdk.handler.a.c.c c(Intent intent) {
        ...
        e.p.a.a.a.c("AbstractMessageHandler", "current taskId " + stringExtra2 + " seqId " + stringExtra3 + " deviceId " + stringExtra4 + " packageName " + stringExtra);
