...
public class MessageV3 implements Parcelable {
    ...
    public static MessageV3 parse(String str, String str2, String str3, MPushMessage mPushMessage) {
        e.p.a.a.a.f(TAG, "V2 message " + mPushMessage);
        ...
        e.p.a.a.a.f(TAG, "MessageV2 extra json is " + jSONObject);
        if (!TextUtils.isEmpty(jSONObject)) {
            messageV3.setNotificationMessage(jSONObject);
        }
        e.p.a.a.a.c(TAG, "parse V2 message to V3 message " + messageV3);
        return messageV3;
    }
        ...
        try {
            ...
            if (!jSONObject.isNull("extra")) {
                ...
                if (!jSONObject2.isNull(PushConstants.TASK_ID) && TextUtils.isEmpty(str5)) {
                    e.p.a.a.a.f(TAG, "Flyme 4 notification message by through message or taskId is null");
            ...
            e.p.a.a.a.f(TAG, "parse message error " + e2.getMessage());
        }
        return messageV3;
    }
