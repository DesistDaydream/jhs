...
public class d {
    ...
    private static Intent a(Context context, Map<String, String> map) {
        ...
        e.p.a.a.a.c("UxIPUtils", "current process packageName " + str2);
        if (!TextUtils.isEmpty(str)) {
            try {
                ...
                e2.printStackTrace();
                e.p.a.a.a.f("UxIPUtils", "getRemotePushTrackerIntent error " + e2.getMessage());
            }
        }
        return null;
    }
    ...
    public static String a(Intent intent) {
        ...
        if (TextUtils.isEmpty(stringExtra)) {
            try {
                ...
                e.p.a.a.a.f("UxIPUtils", "parse MessageV2 error " + e2.getMessage());
    ...
    public static void a(Context context, boolean z, String str, Map<String, String> map) {
        e.p.a.a.a.f("UxIPUtils", "onLogEvent eventName [" + str + "] properties = " + map);
    ...
    private static boolean a(final Context context, final Intent intent, final boolean z, final Map<String, String> map, final long j2) {
        String str;
        if (intent == null) {
            ...
            new Handler(context.getMainLooper()).postDelayed(new Runnable() { // from class: com.meizu.cloud.pushsdk.util.d.1
                ...
                public void run() {
                    try {
                        ...
                        e.p.a.a.a.c("UxIPUtils", "delayed " + j2 + " ms start tracker data in mz_tracker process " + intent.getStringExtra(PushConstants.EXTRA_PUSH_TRACKER_JSON_DATA));
                    } catch (Exception e2) {
                        e2.printStackTrace();
                        e.p.a.a.a.f("UxIPUtils", "delayed startRemotePushTracker error " + e2.getMessage());
            ...
            try {
                context.startService(intent);
                e.p.a.a.a.c("UxIPUtils", "immediately start tracker data in mz_tracker process " + intent.getStringExtra(PushConstants.EXTRA_PUSH_TRACKER_JSON_DATA));
                return true;
            } catch (Exception e2) {
                e2.printStackTrace();
        ...
        e.p.a.a.a.f("UxIPUtils", str);
        return false;
    }

    private static boolean a(Context context, Map<String, String> map, boolean z, long j2) {
        return a(context, a(context, map), z, map, j2);
    }
