...
public class a {
    ...
    public static com.meizu.cloud.pushsdk.d.e.a a(Context context, boolean z) {
        ...
        e.p.a.a.a.c("PushAndroidTracker", "can upload subject " + z);
        if (z) {
            a.a(a(context));
        }
        return a;
    ...
    private static com.meizu.cloud.pushsdk.d.e.a a(com.meizu.cloud.pushsdk.d.b.a aVar, c cVar, Context context) {
        return new com.meizu.cloud.pushsdk.d.e.a.a(new a.C0161a(aVar, "PushAndroidTracker", context.getPackageCodePath(), context, com.meizu.cloud.pushsdk.d.e.a.a.class).a(b.VERBOSE).a(Boolean.FALSE).a(cVar).a(4));
    }
    ...
    private static String a() {
        ...
        e.p.a.a.a.f("QuickTracker", "current statics domain is " + str);
        return str;
    }
    ...
    private static com.meizu.cloud.pushsdk.d.b.a b(Context context, com.meizu.cloud.pushsdk.c.c.a aVar, f fVar) {
        a.C0158a a2 = new a.C0158a(a(), context, com.meizu.cloud.pushsdk.d.b.a.a.class).a(fVar).a(aVar).a(1);
