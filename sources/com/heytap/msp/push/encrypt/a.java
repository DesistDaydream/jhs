...
public class a extends b {
    ...
    private static final int f3362m = 6;
    ...
    */
    ...
    public void a(byte[] bArr, int i2, int i3) {
        ...
        this.f3371j = true;
        if (this.f3373l == 0 && this.f3368g == 0) {
            return;
        }
        a(this.x);
        int i16 = this.f3370i;
        ...
        int i28 = i26 + (i27 - i16);
        this.f3372k = i28;
        if (this.f3368g <= 0 || i28 <= 0) {
            return;
        }
        byte[] bArr9 = this.v;
        System.arraycopy(bArr9, 0, this.f3369h, i27, bArr9.length);
        this.f3370i += this.v.length;
    }
        ...
        while (true) {
            ...
            if (b2 >= 0) {
                ...
                if (b2 < bArr2.length && (b = bArr2[b2]) >= 0) {
                    int i6 = (this.f3373l + 1) % 4;
                    this.f3373l = i6;
                    int i7 = (this.y << 6) + b;
                    this.y = i7;
                    if (i6 == 0) {
                        byte[] bArr3 = this.f3369h;
                        int i8 = this.f3370i;
                        int i9 = i8 + 1;
                        this.f3370i = i9;
