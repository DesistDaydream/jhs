...
public abstract class b implements k.b.a.a.a, k.b.a.a.b {
    ...
    public static final int f3293c = 64;

    /* renamed from: d  reason: collision with root package name */
    public static final int f3294d = 255;

    /* renamed from: e  reason: collision with root package name */
    public static final byte f3295e = 61;

    /* renamed from: m  reason: collision with root package name */
    private static final int f3296m = 8192;

    /* renamed from: f  reason: collision with root package name */
    public final byte f3297f = 61;
    ...
    public b(int i2, int i3, int i4, int i5) {
        this.n = i2;
        this.o = i3;
        this.f3298g = (i4 <= 0 || i5 <= 0) ? 0 : (i4 / i3) * i3;
        this.p = i5;
    }

    private void a() {
        byte[] bArr = this.f3299h;
        if (bArr == null) {
            this.f3299h = new byte[d()];
            this.f3300i = 0;
            this.q = 0;
            return;
        }
    ...
    public void a(int i2) {
        byte[] bArr = this.f3299h;
        if (bArr == null || bArr.length < this.f3300i + i2) {
            a();
        }
    }
    ...
    public int c(byte[] bArr, int i2, int i3) {
        if (this.f3299h == null) {
            return this.f3301j ? -1 : 0;
        }
        int min = Math.min(c(), i3);
        System.arraycopy(this.f3299h, this.q, bArr, i2, min);
        int i4 = this.q + min;
        this.q = i4;
        if (i4 >= this.f3300i) {
            this.f3299h = null;
