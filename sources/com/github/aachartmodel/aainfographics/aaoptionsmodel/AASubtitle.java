...
public final class AASubtitle {
    ...
    @d
    public final AASubtitle align(@e AAChartAlignType aAChartAlignType) {
        this.align = aAChartAlignType != null ? aAChartAlignType.getValue() : null;
        return this;
    }

    @d
    public final AASubtitle style(@e AAStyle aAStyle) {
        this.style = aAStyle;
        return this;
    }

    @d
    public final AASubtitle text(@e String str) {
        this.text = str;
        return this;
    }

    @d
    public final AASubtitle userHTML(@e Boolean bool) {
        this.userHTML = bool;
        return this;
    }

    @d
    public final AASubtitle verticalAlign(@d AAChartVerticalAlignType aAChartVerticalAlignType) {
        this.verticalAlign = aAChartVerticalAlignType.toString();
        return this;
    }

    @d
    public final AASubtitle x(@e Number number) {
        this.x = number;
        return this;
    }

    @d
    public final AASubtitle y(@e Number number) {
        this.y = number;
        return this;
    }
}
