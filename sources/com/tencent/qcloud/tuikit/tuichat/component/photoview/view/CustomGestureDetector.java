...
public class CustomGestureDetector {
    ...
    public CustomGestureDetector(Context context, OnGestureListener onGestureListener) {
        ...
        this.mDetector = new ScaleGestureDetector(context, new ScaleGestureDetector.OnScaleGestureListener() { // from class: com.tencent.qcloud.tuikit.tuichat.component.photoview.view.CustomGestureDetector.1
