...
public abstract class V2TIMGroupManager {
    ...
    public abstract void getGroupMemberList(String str, int i2, long j2, V2TIMValueCallback<V2TIMGroupMemberInfoResult> v2TIMValueCallback);
    ...
    public abstract void muteGroupMember(String str, String str2, int i2, V2TIMCallback v2TIMCallback);
    ...
    public abstract void setGroupMemberRole(String str, String str2, int i2, V2TIMCallback v2TIMCallback);
