...
public class b extends AsyncTask<Void, Void, a> {
                    ...
                    try {
                        ...
                        if (string != null && string.length() != 0) {
                            ...
                            if (decode != null && decode.length != 0) {
                                ...
                                aVar.f6825c = string2;
                                Log.d("MicroMsg.SDK.GetQRCodeResult", String.format("parse succ, save in memory, uuid = %s, appname = %s, imgBufLength = %d", aVar.b, string2, Integer.valueOf(aVar.f6827e.length)));
                                return aVar;
                            }
    ...
    public a doInBackground(Void[] voidArr) {
        ...
        String format = String.format("https://open.weixin.qq.com/connect/sdk/qrconnect?appid=%s&noncestr=%s&timestamp=%s&scope=%s&signature=%s", this.a, this.f6820c, this.f6821d, this.b, this.f6822e);
        long currentTimeMillis = System.currentTimeMillis();
        byte[] a2 = com.tencent.mm.opensdk.channel.a.a.a(format, (int) BaseConstants.Time.MINUTE);
    ...
    public void onPostExecute(a aVar) {
        ...
        if (oAuthErrCode == OAuthErrCode.WechatAuth_Err_OK) {
            Log.d("MicroMsg.SDK.GetQRCodeTask", "onPostExecute, get qrcode success imgBufSize = " + aVar2.f6827e.length);
            this.f6823f.onAuthGotQrcode(aVar2.f6826d, aVar2.f6827e);
            c cVar = new c(aVar2.b, this.f6823f);
            this.f6824g = cVar;
        ...
        this.f6823f.onAuthFinish(aVar2.a, null);
    }
}
