...
public class BaseWXApiImplV10 implements IWXAPI {
        ...
        try {
            ...
            if (iWXChannelJumpInfo instanceof WXChannelBaseJumpInfo) {
                ...
                if (iWXChannelJumpInfo instanceof WXChannelJumpMiniProgramInfo) {
                    jSONObject.put(IMChatManager.CONSTANT_USERNAME, ((WXChannelJumpMiniProgramInfo) iWXChannelJumpInfo).username);
    ...
    private String getTokenFromWX(Context context) {
        Cursor query = context.getContentResolver().query(Uri.parse("content://com.tencent.mm.sdk.comm.provider/genTokenForOpenSdk"), null, null, new String[]{this.appId, "638063104"}, null);
    ...
    private boolean handleWxInternalRespType(String str, IWXAPIEventHandler iWXAPIEventHandler) {
        ...
        if (b.b(queryParameter)) {
            ...
            resp.openId = parse.getQueryParameter(k.f10146c);
            ...
            resp5.openId = parse.getQueryParameter(k.f10146c);
    ...
    public boolean registerApp(String str, long j2) {
        ...
        c0241a.a = "com.tencent.mm";
        c0241a.b = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        c0241a.f6815c = "weixin://registerapp?appid=" + this.appId;
        c0241a.f6816d = j2;
        return a.a(this.context, c0241a);
    }
    ...
    public void unregisterApp() {
        ...
        a.C0241a c0241a = new a.C0241a();
        c0241a.a = "com.tencent.mm";
        c0241a.b = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        c0241a.f6815c = "weixin://unregisterapp?appid=" + this.appId;
        a.a(this.context, c0241a);
    }
}
