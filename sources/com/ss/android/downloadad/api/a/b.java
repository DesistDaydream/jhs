...
public class b implements a {
    ...
    public final AtomicBoolean f5174c;

    /* renamed from: d  reason: collision with root package name */
    public final AtomicBoolean f5175d;
    ...
    public JSONObject ae() {
        ...
        try {
            jSONObject.put("mId", this.f5176e);
            jSONObject.put("mExtValue", this.f5177f);
            jSONObject.put("mLogExtra", this.f5178g);
            jSONObject.put("mDownloadStatus", this.f5179h);
            jSONObject.put("mPackageName", this.f5180i);
            ...
            jSONObject.put("mDownloadUrl", this.f5181j);
            jSONObject.put("mEnableBackDialog", this.x);
            jSONObject.put("hasSendInstallFinish", this.f5174c.get());
            jSONObject.put("hasSendDownloadFailedFinally", this.f5175d.get());
            jSONObject.put("mLastFailedErrCode", this.E);
            jSONObject.put("mLastFailedErrMsg", this.F);
            jSONObject.put("mOpenUrl", this.f5182k);
            jSONObject.put("mLinkMode", this.n);
            jSONObject.put("mDownloadMode", this.o);
            jSONObject.put("mModelType", this.f5184m);
            ...
            jSONObject.put("webUrl", this.f5183l);
    ...
    public AdDownloadModel af() {
        return new AdDownloadModel.Builder().setAdId(this.f5176e).setExtraValue(this.f5177f).setLogExtra(this.f5178g).setPackageName(this.f5180i).setExtra(this.v).setIsAd(this.t).setVersionCode(this.p).setVersionName(this.q).setDownloadUrl(this.f5181j).setModelType(this.f5184m).setMimeType(this.H).setAppName(this.r).setAppIcon(this.s).setDeepLink(new DeepLink(this.f5182k, this.f5183l, null)).build();
    }
    ...
    public static b b(JSONObject jSONObject) {
        ...
        try {
            ...
            bVar.f5174c.set(jSONObject.optBoolean("hasSendInstallFinish"));
            bVar.f5175d.set(jSONObject.optBoolean("hasSendDownloadFailedFinally"));
    ...
    public b(DownloadModel downloadModel, DownloadEventConfig downloadEventConfig, DownloadController downloadController, int i2) {
        ...
        this.T = true;
        this.Z = -1L;
        this.f5176e = downloadModel.getId();
        this.f5177f = downloadModel.getExtraValue();
        this.f5178g = downloadModel.getLogExtra();
        this.f5180i = downloadModel.getPackageName();
        ...
        this.f5181j = downloadModel.getDownloadUrl();
        if (downloadModel.getDeepLink() != null) {
            this.f5182k = downloadModel.getDeepLink().getOpenUrl();
            this.f5183l = downloadModel.getDeepLink().getWebUrl();
        }
        this.f5184m = downloadModel.getModelType();
