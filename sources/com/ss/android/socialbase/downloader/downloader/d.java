...
public class d {
    ...
    /* renamed from: c */
    private Handler f5609c = new Handler(Looper.getMainLooper());

    /* renamed from: d */
    private volatile List<ac> f5610d = new ArrayList();
    ...
    public void b(ac acVar) {
        ...
        synchronized (this.f5610d) {
            if (this.f5610d.contains(acVar)) {
                this.f5610d.remove(acVar);
            }
        }
    }
    ...
    public void a(final DownloadTask downloadTask) {
        ...
        if (b == null) {
            ...
            this.f5609c.postDelayed(new Runnable() { // from class: com.ss.android.socialbase.downloader.downloader.d.1
                {
                    d.this = this;
                }
