...
public class DownloadHandlerService extends Service {
    ...
    */
    ...
    private static void a(Context context, int i2, boolean z) {
        ...
        if (z && (m2 = com.ss.android.socialbase.downloader.downloader.d.a().m(i2)) != null) {
            try {
    ...
    public static void a(Context context, DownloadInfo downloadInfo, com.ss.android.socialbase.appdownloader.c.d dVar, z zVar) {
        ...
        int id = downloadInfo.getId();
        af m2 = com.ss.android.socialbase.downloader.downloader.d.a().m(id);
        if (AdBaseConstants.MIME_APK.equals(downloadInfo.getMimeType()) && m2 != null && c.a(context, downloadInfo) && m2.c(downloadInfo)) {
            return;
        }
        boolean z = false;
