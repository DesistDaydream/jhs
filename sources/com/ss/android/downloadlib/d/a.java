...
public class a {
    ...
    public void a(long j2, int i2) {
        ...
        if (e2.x()) {
        ...
        } else if (e2.f5256c.isEnableClickEvent()) {
            int i3 = 1;
            DownloadEventConfig downloadEventConfig = e2.f5256c;
            String clickItemTag = i2 == 1 ? downloadEventConfig.getClickItemTag() : downloadEventConfig.getClickButtonTag();
            String a = l.a(e2.f5256c.getClickLabel(), "click");
            ...
            if (!"click".equals(a) || e2.b == null) {
                return;
            }
            c.a().a(j2, e2.b.getLogExtra());
        }
    }
    ...
    public void b(DownloadInfo downloadInfo, BaseException baseException) {
        ...
        if (a == null) {
            ...
            try {
                ...
                int i2 = 1;
                jSONObject.put("has_send_download_failed_finally", a.f5175d.get() ? 1 : 2);
    ...
    public void a(long j2, int i2, DownloadInfo downloadInfo) {
        ...
        if (i2 == 1) {
            str = l.a(e2.f5256c.getStorageDenyLabel(), "storage_deny");
        } else if (i2 == 2) {
            str = l.a(e2.f5256c.getClickStartLabel(), "click_start");
            com.ss.android.downloadlib.g.f.a(downloadInfo, jSONObject);
        } else if (i2 == 3) {
            str = l.a(e2.f5256c.getClickPauseLabel(), "click_pause");
            com.ss.android.downloadlib.g.f.b(downloadInfo, jSONObject);
        } else if (i2 == 4) {
            str = l.a(e2.f5256c.getClickContinueLabel(), "click_continue");
            com.ss.android.downloadlib.g.f.c(downloadInfo, jSONObject);
        } else if (i2 == 5) {
            if (downloadInfo != null) {
                try {
            ...
            str = l.a(e2.f5256c.getClickInstallLabel(), "click_install");
        }
    ...
    public void a(long j2, boolean z, int i2) {
        ...
        } else if (e2.b.getQuickAppModel() == null) {
        } else {
            DownloadModel downloadModel = e2.b;
    ...
    public void a(DownloadInfo downloadInfo, BaseException baseException) {
        ...
        if (downloadInfo == null || (a = f.a().a(downloadInfo)) == null || a.f5174c.get()) {
            return;
        }
        JSONObject jSONObject = new JSONObject();
        try {
