...
public class a {
    ...
    private void a(final Context context, final com.ss.android.downloadlib.addownload.b.a aVar, final InterfaceC0175a interfaceC0175a, boolean z) {
        ...
        objArr[0] = TextUtils.isEmpty(aVar.f5233e) ? "刚刚下载的应用" : aVar.f5233e;
        c2.b(a2.b(String.format("%1$s下载完成，是否立即安装？", objArr)).c("立即安装").d(z ? "暂不安装" : String.format("退出%1$s", context.getResources().getString(context.getApplicationContext().getApplicationInfo().labelRes))).a(false).a(l.a(context, aVar.f5235g)).a(new b.InterfaceC0170b() { // from class: com.ss.android.downloadlib.addownload.a.a.1
