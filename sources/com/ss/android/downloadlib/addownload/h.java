...
public class h {
    ...
    private static com.ss.android.downloadad.api.a.b a(com.ss.android.downloadlib.addownload.b.e eVar, int i2) {
        com.ss.android.downloadad.api.a.b bVar = new com.ss.android.downloadad.api.a.b(eVar.b, eVar.f5256c, eVar.f5257d, i2);
        boolean z = true;
    ...
    private static int a(com.ss.android.socialbase.appdownloader.f fVar, String str) {
        ...
        String str2 = c2 + File.separator + com.ss.android.socialbase.appdownloader.c.a(b, a);
        ...
        } else if (a2 != null || !AdBaseConstants.MIME_APK.equalsIgnoreCase(com.ss.android.socialbase.appdownloader.d.j().a(L, fVar.l()))) {
            return a2 != null ? 8 : 9;
        } else {
