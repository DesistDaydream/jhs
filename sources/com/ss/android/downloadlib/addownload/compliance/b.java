...
public class b {
    ...
    public void b(long j2) {
        com.ss.android.downloadlib.addownload.e a2 = f.a().a(com.ss.android.downloadlib.addownload.b.f.a().e(j2).b.getDownloadUrl());
        if (a2 != null) {
            a2.a(true, true);
            return;
        }
    ...
    public boolean a(@NonNull com.ss.android.downloadlib.addownload.b.e eVar) {
        ...
        if (!TextUtils.isEmpty(eVar.b.getLogExtra())) {
            try {
                j2 = l.a(new JSONObject(eVar.b.getLogExtra()), "convert_id");
            } catch (Exception e2) {
                e2.printStackTrace();
                j2 = 0;
            }
    ...
    public boolean a(long j2, long j3, String str) {
        try {
            ...
            if (optJSONObject != null && optJSONObject.length() != 0) {
                ...
                bVar.a = j2;
                bVar.b = j3;
                bVar.f5238d = optJSONObject.optString("icon_url");
                bVar.f5239e = optJSONObject.optString("app_name");
                bVar.f5237c = optJSONObject.optString("package_name");
                bVar.f5240f = optJSONObject.optString(NativeUnifiedADAppInfoImpl.Keys.VERSION_NAME);
                bVar.f5241g = optJSONObject.optString("developer_name");
                bVar.f5243i = optJSONObject.optString("policy_url");
                ...
                if (optJSONArray != null) {
                    for (int i2 = 0; i2 < optJSONArray.length(); i2++) {
                        ...
                        bVar.f5242h.add(new Pair<>(jSONObject.optString("permission_name"), jSONObject.optString("permission_desc")));
                    }
                }
                c.a().a(bVar);
                d.a().a(bVar.a(), j3, bVar.f5238d);
                return true;
            }
            e.a(7, j3);
            return false;
