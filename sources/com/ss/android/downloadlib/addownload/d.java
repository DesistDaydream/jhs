...
public class d {
    ...
    private AtomicBoolean f5290c = new AtomicBoolean(false);

    /* renamed from: d  reason: collision with root package name */
    private AtomicBoolean f5291d = new AtomicBoolean(false);
    ...
    public void a(final int i2, final long j2, long j3, final e.a aVar) {
        ...
        if (com.ss.android.downloadlib.g.e.f(i2) && com.ss.android.downloadlib.g.e.e(i2)) {
            ...
            if (b == null) {
                ...
                b = new com.ss.android.downloadad.api.a.b(eVar.b, eVar.f5256c, eVar.f5257d, 0);
            ...
            this.a.postDelayed(new Runnable() { // from class: com.ss.android.downloadlib.addownload.d.2
                ...
                public void run() {
                    if (d.this.f5290c.get()) {
                        return;
                    }
                    d.this.f5290c.set(true);
                    aVar.a();
                }
            }, c2);
            return;
