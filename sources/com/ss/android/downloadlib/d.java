...
public class d {
    ...
    private ScheduledExecutorService f5363c;
    ...
    public ScheduledExecutorService d() {
        if (this.f5363c == null) {
            synchronized (d.class) {
                if (this.f5363c == null) {
                    this.f5363c = new ScheduledThreadPoolExecutor(0, new com.ss.android.socialbase.downloader.h.a(g.class.getName() + "-ScheduledThreadPool"));
                }
            }
        }
        return this.f5363c;
