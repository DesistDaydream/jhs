...
public class TTDelegateActivity extends Activity implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    public void onStop() {
        DownloadInfo a;
        super.onStop();
        if (!this.b || this.f5209c == null || (a = g.a((Context) null).a(this.f5209c.a())) == null || a.getCurBytes() < a.getTotalBytes() || isFinishing()) {
            return;
        }
        finish();
    }
    ...
    private void c(long j2) {
        ...
        c2.b(a.b(String.format("%1$s已安装完成，是否立即打开？", objArr)).c("打开").d("取消").a(false).a(com.ss.android.downloadlib.g.l.c(this, d2.e())).a(new b.InterfaceC0170b() { // from class: com.ss.android.downloadlib.activity.TTDelegateActivity.2
    ...
    private void b(final String str, String[] strArr) {
        if (!TextUtils.isEmpty(str) && strArr != null && strArr.length > 0) {
            s sVar = new s() { // from class: com.ss.android.downloadlib.activity.TTDelegateActivity.1
                ...
                /* renamed from: c  reason: collision with root package name */
                private WeakReference<Activity> f5210c;

                {
                    this.f5210c = new WeakReference<>(TTDelegateActivity.this);
                }

                @Override // com.ss.android.download.api.config.s
                public void a() {
                    com.ss.android.downloadlib.g.j.a(str);
                    com.ss.android.socialbase.appdownloader.c.a(this.f5210c.get());
                }
    ...
    public void a() {
        ...
        switch (intent.getIntExtra("type", 0)) {
            case 1:
                b(this.a.getStringExtra(com.bytedance.msdk.api.activity.TTDelegateActivity.PERMISSION_ID_KEY), this.a.getStringArrayExtra(com.bytedance.msdk.api.activity.TTDelegateActivity.PERMISSION_CONTENT_KEY));
                break;
            case 2:
            ...
            case 11:
                ...
                break;
            case 12:
                h.a(this, this.a.getStringExtra("package_name"), this.a.getLongExtra("model_id", 0L), this.a.getStringExtra(RemoteMessageConst.MessageBody.PARAM), this.a.getStringExtra("ext_json"));
                com.ss.android.socialbase.appdownloader.c.a((Activity) this);
                break;
        }
        this.a = null;
