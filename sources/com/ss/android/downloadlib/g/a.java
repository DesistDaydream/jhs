...
public class a {
    ...
    public static void c() {
        ...
        try {
            ...
            declaredField2.set(obj, Proxy.newProxyInstance(Thread.currentThread().getContextClassLoader(), new Class[]{cls}, new C0180a(obj2)));
        } catch (Throwable unused) {
        }
    }
        ...
        if (com.ss.android.downloadlib.addownload.j.i().optInt("hook", 0) == 1 && (objArr[1] instanceof String) && (objArr[2] instanceof Intent)) {
            ...
            if ("android.intent.action.VIEW".equals(intent.getAction()) && com.ss.android.socialbase.downloader.constants.e.a.equals(intent.getType())) {
                if (com.ss.android.socialbase.appdownloader.f.d.c()) {
                    ...
                    String optString2 = i2.optString("hook_kllk_arg1", "com." + com.ss.android.socialbase.downloader.constants.e.f5569c + ".market");
                    ...
                    String optString4 = i3.optString("hook_kllk_arg3", "m.store." + com.ss.android.socialbase.downloader.constants.e.f5569c + "mobile.com");
                    StringBuilder sb = new StringBuilder();
                    sb.append(com.ss.android.socialbase.downloader.constants.e.f5569c);
                    ...
                    if (com.ss.android.downloadlib.addownload.j.i().optInt("hook_kllk_arg4", 0) == 1) {
                        ...
                        intent2.putExtra(com.ss.android.socialbase.downloader.constants.e.f5569c + "_extra_pkg_name", optString3);
