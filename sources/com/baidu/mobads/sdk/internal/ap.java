...
public class ap {
    public static bj a = bj.a();
    private static final String b = "com.baidu.mobads.sdk.internal.ap";
    ...
    public static ClassLoader a(Context context) {
        return al.a(bp.a(context), context.getFilesDir().getAbsolutePath(), (String) null, ap.class.getClassLoader());
    }
}
