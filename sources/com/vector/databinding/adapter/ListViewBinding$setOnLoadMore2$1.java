...
public final class ListViewBinding$setOnLoadMore2$1 extends Lambda implements l<LoadMore.State, t1> {
    public final /* synthetic */ p $binding;
    public final /* synthetic */ ListView $view;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ListViewBinding$setOnLoadMore2$1(p pVar, ListView listView) {
        super(1);
        this.$binding = pVar;
        this.$view = listView;
    }
