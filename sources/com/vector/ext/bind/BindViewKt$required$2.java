...
public final class BindViewKt$required$2 extends Lambda implements p<T, n<?>, List<? extends V>> {
    public final /* synthetic */ p<T, Integer, View> $finder;
    public final /* synthetic */ int[] $ids;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public BindViewKt$required$2(int[] iArr, p<? super T, ? super Integer, ? extends View> pVar) {
        super(2);
        this.$ids = iArr;
        this.$finder = pVar;
    }
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, n<?> nVar) {
        return invoke2((BindViewKt$required$2) obj, nVar);
    }
    ...
    public final List<V> invoke2(T t, @d n<?> nVar) {
        ...
        for (int i2 : iArr) {
            View invoke = pVar.invoke(t, Integer.valueOf(i2));
            if (invoke == null) {
                BindViewKt.R(i2, nVar);
