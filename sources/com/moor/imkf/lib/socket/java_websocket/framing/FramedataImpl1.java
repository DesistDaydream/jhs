...
public abstract class FramedataImpl1 implements Framedata {
    ...
    /* renamed from: com.moor.imkf.lib.socket.java_websocket.framing.FramedataImpl1$1  reason: invalid class name */
    /* loaded from: classes2.dex */
    public static /* synthetic */ class AnonymousClass1 {
        public static final /* synthetic */ int[] $SwitchMap$com$moor$imkf$lib$socket$java_websocket$enums$Opcode;

        static {
            int[] iArr = new int[Opcode.values().length];
            $SwitchMap$com$moor$imkf$lib$socket$java_websocket$enums$Opcode = iArr;
            try {
                iArr[Opcode.PING.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$moor$imkf$lib$socket$java_websocket$enums$Opcode[Opcode.PONG.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$com$moor$imkf$lib$socket$java_websocket$enums$Opcode[Opcode.TEXT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                $SwitchMap$com$moor$imkf$lib$socket$java_websocket$enums$Opcode[Opcode.BINARY.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                $SwitchMap$com$moor$imkf$lib$socket$java_websocket$enums$Opcode[Opcode.CLOSING.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                $SwitchMap$com$moor$imkf$lib$socket$java_websocket$enums$Opcode[Opcode.CONTINUOUS.ordinal()] = 6;
    ...
    public static FramedataImpl1 get(Opcode opcode) {
        if (opcode != null) {
            switch (AnonymousClass1.$SwitchMap$com$moor$imkf$lib$socket$java_websocket$enums$Opcode[opcode.ordinal()]) {
                case 1:
    ...
    @Override // com.moor.imkf.lib.socket.java_websocket.framing.Framedata
