    ...
    public void onBindViewHolder(SwipeHolder swipeHolder, final int i2) {
        ...
        swipeHolder.rl_item.setOnClickListener(new View.OnClickListener() { // from class: com.m7.imkfsdk.chat.adapter.DetailQuestionAdapter.1
            ...
            public void onClick(View view) {
                String title = ((DetailsQuestionBean) DetailQuestionAdapter.this.list.get(i2)).getTitle();
                try {
                    String encode = URLEncoder.encode("【常见问题】" + title, Constants.UTF_8);
                    IMChat.getInstance().sendQuestionMsg(((DetailsQuestionBean) DetailQuestionAdapter.this.list.get(i2)).getQuestionId(), encode, IMMessage.createQuestionMessage(encode), new ChatListener() { // from class: com.m7.imkfsdk.chat.adapter.DetailQuestionAdapter.1.1
