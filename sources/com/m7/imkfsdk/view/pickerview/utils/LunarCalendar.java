...
public class LunarCalendar {
    ...
    private static final int[] DAYS_BEFORE_MONTH = {0, 31, 59, 90, 120, 151, 181, AdEventType.VIDEO_PRELOADED, 243, 273, 304, 334, 365};
    ...
    public static final int[] lunarToSolar(int i2, int i3, int i4, boolean z) {
        if (i2 >= 1900 && i2 <= 2099 && i3 >= 1 && i3 <= 12 && i4 >= 1 && i4 <= 30) {
            ...
            for (int i7 = 1; i7 < i3; i7++) {
                i6 = ((524288 >> (i7 + (-1))) & LUNAR_INFO[i5]) == 0 ? i6 + 29 : i6 + 30;
            }
            int i8 = i6 + i4;
    ...
    public static final int[] solarToLunar(int i2, int i3, int i4) {
        ...
        int i7 = iArr2[i6];
        long solarToInt = solarToInt(i2, i3, i4) - solarToInt(getBitInt(i7, 12, 9), getBitInt(i7, 4, 5), getBitInt(i7, 5, 0));
    ...
    public static final int[] solarToLunarDeprecated(int i2, int i3, int i4) {
        ...
        int i5 = MIN_YEAR;
        int i6 = 0;
        int time = (int) ((new GregorianCalendar(i2, i3 - 1, i4).getTime().getTime() - new GregorianCalendar(MIN_YEAR, 0, 31).getTime().getTime()) / 86400000);
        int i7 = 0;
        while (i5 <= 2099 && time > 0) {
            i7 = daysInLunarYear(i5);
            time -= i7;
            i5++;
        }
        if (time < 0) {
        ...
        int i9 = 0;
        while (i8 <= 13 && time > 0) {
            i9 = daysInLunarMonth(i5, i8);
            time -= i9;
            i8++;
        }
        if (leapMonth != 0 && i8 > leapMonth) {
            i8--;
            Log.i("----------->", i2 + Constants.ACCEPT_TIME_SEPARATOR_SERVER + i3 + Constants.ACCEPT_TIME_SEPARATOR_SERVER + i4 + "====>" + i8 + Constants.ACCEPT_TIME_SEPARATOR_SERVER + leapMonth);
            if (i8 == leapMonth) {
                i6 = 1;
            }
        }
    ...
    public static final int daysInMonth(int i2, int i3, boolean z) {
        ...
        int i4 = (leapMonth == 0 || i3 <= leapMonth) ? 0 : 1;
        if (z) {
