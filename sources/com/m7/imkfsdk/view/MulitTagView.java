    ...
    public class TagSelectAdapter extends RecyclerView.Adapter<MineContactViewHolder> {
        ...
        public void onBindViewHolder(MineContactViewHolder mineContactViewHolder, final int i2) {
            ...
            if (option.isSelected) {
                ...
                mineContactViewHolder.mulit_checkbox.setChecked(true);
                mineContactViewHolder.mulit_checkbox.setTextColor(FIleResourceUtil.getCurrentColor(MulitTagView.this.context, R.attr.ykfsdk_ykf_theme_color_default));
                mineContactViewHolder.rl_checkbg.setBackground(ContextCompat.getDrawable(this.mContext, R.drawable.ykfsdk_kf_bg_xbot_tiempress));
            } else {
                mineContactViewHolder.rl_checkbg.setBackground(ContextCompat.getDrawable(this.mContext, R.drawable.ykfsdk_kf_bg_xbot_tiem));
                mineContactViewHolder.mulit_checkbox.setChecked(false);
                mineContactViewHolder.mulit_checkbox.setTextColor(MulitTagView.this.context.getResources().getColor(R.color.ykfsdk_color_333333));
            }
            mineContactViewHolder.mulit_checkbox.setText(option.name);
            mineContactViewHolder.mulit_checkbox.setOnClickListener(new View.OnClickListener() { // from class: com.m7.imkfsdk.view.MulitTagView.TagSelectAdapter.1
                ...
                public void onClick(View view) {
                    ...
                    if (TagSelectAdapter.this.broadcas.size() > 0) {
                        MulitTagView.this.optionLists.clear();
                        MulitTagView.this.optionLists.addAll(TagSelectAdapter.this.broadcas);
                        MulitTagView.this.onSelectedChangeListener.getTagList(MulitTagView.this.optionLists);
                    }
                }
            });
        }
        ...
        public MineContactViewHolder onCreateViewHolder(ViewGroup viewGroup, int i2) {
            return new MineContactViewHolder(this.layoutInflater.inflate(R.layout.ykfsdk_kf_xbotform_mulititem, viewGroup, false));
        }
    }
    ...
    public class TagSingleSelectAdapter extends RecyclerView.Adapter<SingleTagViewHolder> {
        ...
        public void onBindViewHolder(final SingleTagViewHolder singleTagViewHolder, int i2, List list) {
            ...
            if (list.isEmpty()) {
                ...
                singleTagViewHolder.tv_title.setOnClickListener(new View.OnClickListener() { // from class: com.m7.imkfsdk.view.MulitTagView.TagSingleSelectAdapter.1
                    @Override // android.view.View.OnClickListener
                    public void onClick(View view) {
                        ...
                        if (option2.isSelected) {
                            ...
                            mulitTagView.SelectedPosition = -1;
                            mulitTagView.onSelectedChangeListener.getTagList(MulitTagView.this.optionLists);
                            return;
                        }
                        TagSingleSelectAdapter tagSingleSelectAdapter = TagSingleSelectAdapter.this;
                        if (MulitTagView.this.SelectedPosition != -1) {
                            Option option3 = (Option) tagSingleSelectAdapter.list.get(MulitTagView.this.SelectedPosition);
                            option3.isSelected = false;
                            TagSingleSelectAdapter tagSingleSelectAdapter2 = TagSingleSelectAdapter.this;
                            tagSingleSelectAdapter2.notifyItemChanged(MulitTagView.this.SelectedPosition, option3);
                            MulitTagView.this.onSelectedChangeListener.getTagList(MulitTagView.this.optionLists);
                        }
                        TagSingleSelectAdapter tagSingleSelectAdapter3 = TagSingleSelectAdapter.this;
                        MulitTagView.this.SelectedPosition = intValue;
                        option2.isSelected = true;
                        tagSingleSelectAdapter3.broadcas.clear();
                        TagSingleSelectAdapter.this.broadcas.add(option2);
                        TagSingleSelectAdapter.this.notifyItemChanged(intValue, option2);
                        MulitTagView.this.optionLists.clear();
                        MulitTagView.this.optionLists.addAll(TagSingleSelectAdapter.this.broadcas);
                        MulitTagView.this.onSelectedChangeListener.getTagList(MulitTagView.this.optionLists);
                    }
                });
