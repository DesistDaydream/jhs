...
public class CustomGestureDetector {
    ...
    public CustomGestureDetector(Context context, OnGestureListener onGestureListener) {
        ...
        this.mDetector = new ScaleGestureDetector(context, new ScaleGestureDetector.OnScaleGestureListener() { // from class: com.m7.imkfsdk.view.imageviewer.photoview.CustomGestureDetector.1
