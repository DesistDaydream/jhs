...
public class RangeSlider extends BaseSlider<RangeSlider, b, c> {
    ...
    /* loaded from: classes2.dex */
    public interface b extends e.j.a.c.a0.a<RangeSlider> {
    }

    /* loaded from: classes2.dex */
    public interface c extends e.j.a.c.a0.b<RangeSlider> {
    }
    ...
    private static List<Float> v0(TypedArray typedArray) {
    ...
    public void onRestoreInstanceState(@Nullable Parcelable parcelable) {
        ...
        this.K0 = rangeSliderState.minSeparation;
    ...
    public Parcelable onSaveInstanceState() {
        ...
        rangeSliderState.minSeparation = this.K0;
        rangeSliderState.separationUnit = this.L0;
    ...
    public RangeSlider(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        TypedArray j2 = m.j(context, attributeSet, R.styleable.RangeSlider, i2, BaseSlider.m0, new int[0]);
        int i3 = R.styleable.RangeSlider_values;
        if (j2.hasValue(i3)) {
            setValues(v0(j2.getResources().obtainTypedArray(j2.getResourceId(i3, 0))));
        }
        this.K0 = j2.getDimension(R.styleable.RangeSlider_minSeparation, 0.0f);
        j2.recycle();
    }
}
