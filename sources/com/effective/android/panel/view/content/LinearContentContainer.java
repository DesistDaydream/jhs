...
public final class LinearContentContainer extends LinearLayout implements IContentContainer {
    ...
    @h
    public LinearContentContainer(@e Context context) {
        this(context, null, 0, 6, null);
    }

    @h
    public LinearContentContainer(@e Context context, @e AttributeSet attributeSet) {
        this(context, attributeSet, 0, 4, null);
    }

    @h
    public LinearContentContainer(@e Context context, @e AttributeSet attributeSet, int i2) {
    ...
    public /* synthetic */ LinearContentContainer(Context context, AttributeSet attributeSet, int i2, int i3, u uVar) {
        this(context, (i3 & 2) != 0 ? null : attributeSet, (i3 & 4) != 0 ? 0 : i2);
    }

    @TargetApi(21)
    public LinearContentContainer(@e Context context, @e AttributeSet attributeSet, int i2, int i3) {
