...
public final class FrameContentContainer extends FrameLayout implements IContentContainer {
    ...
    @h
    public FrameContentContainer(@e Context context) {
        this(context, null, 0, 6, null);
    }

    @h
    public FrameContentContainer(@e Context context, @e AttributeSet attributeSet) {
        this(context, attributeSet, 0, 4, null);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    @h
    public FrameContentContainer(@e Context context, @e AttributeSet attributeSet, int i2) {
    ...
    public /* synthetic */ FrameContentContainer(Context context, AttributeSet attributeSet, int i2, int i3, u uVar) {
        this(context, (i3 & 2) != 0 ? null : attributeSet, (i3 & 4) != 0 ? 0 : i2);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    @TargetApi(21)
    public FrameContentContainer(@e Context context, @e AttributeSet attributeSet, int i2, int i3) {
