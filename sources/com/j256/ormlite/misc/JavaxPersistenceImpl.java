...
public class JavaxPersistenceImpl implements JavaxPersistenceConfigurer {
    ...
    public DatabaseFieldConfig createFieldConfig(DatabaseType databaseType, Field field) {
        ...
        databaseFieldConfig.setUseGetSet((DatabaseFieldConfig.findGetMethod(field, databaseType, false) == null || DatabaseFieldConfig.findSetMethod(field, databaseType, false) == null) ? false : false);
