...
public class UdpDns extends BaseDns implements Dns {
    ...
    public UdpDns(int i2) {
        ...
        if (udpDnsIpv4Servers != null && udpDnsIpv4Servers.length > 0) {
            this.udpIpv4Resolver = new DnsUdpResolver(udpDnsIpv4Servers, 1, i2, BaseDns.executor);
        }
        ...
        this.udpIpv6Resolver = new DnsUdpResolver(udpDnsIpv6Servers, 1, i2, BaseDns.executor);
    }
    ...
    */
    public java.util.List<com.qiniu.android.http.dns.IDnsNetworkAddress> lookup(java.lang.String r14) throws java.net.UnknownHostException {
        /*
            ...
            boolean r0 = r0.udpDnsEnable
            r1 = 0
            if (r0 != 0) goto La
            return r1
        La:
            com.qiniu.android.dns.IResolver r0 = r13.udpIpv4Resolver
            if (r0 != 0) goto L1b
            com.qiniu.android.dns.IResolver r2 = r13.udpIpv6Resolver
            if (r2 == 0) goto L13
            goto L1b
        L13:
        ...
        L8c:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.qiniu.android.http.dns.UdpDns.lookup(java.lang.String):java.util.List");
    }
}
