...
public final class z {
    ...
    private static String[] b = {"android.permission.INTERNET", PermissionConstants.PHONE_STATE, "android.permission.ACCESS_NETWORK_STATE", "android.permission.WRITE_SETTINGS", "android.permission.VIBRATE", PermissionConstants.STORE, "android.permission.ACCESS_WIFI_STATE", "android.permission.WAKE_LOCK", "android.permission.GET_ACCOUNTS", "com.bbk.account.permission.READ_ACCOUNTINFO", "android.permission.AUTHENTICATE_ACCOUNTS", "android.permission.MOUNT_UNMOUNT_FILESYSTEMS", "android.permission.GET_TASKS"};

    /* renamed from: c  reason: collision with root package name */
    private static String[] f8180c = {"com.vivo.push.sdk.service.CommandService", "com.vivo.push.sdk.service.CommonJobService"};

    /* renamed from: d  reason: collision with root package name */
    private static String[] f8181d = {"com.vivo.push.sdk.RegistrationReceiver"};

    /* renamed from: e  reason: collision with root package name */
    private static String[] f8182e = new String[0];

    /* renamed from: f  reason: collision with root package name */
    private static Map<String, Bundle> f8183f = new ConcurrentHashMap();
    ...
    */
    ...
    public static Object a(Context context, String str, String str2) {
        ...
        try {
            Map<String, Bundle> map = f8183f;
            Object obj2 = (map == null || map.size() <= 0 || (bundle = f8183f.get(str)) == null) ? null : bundle.get(str2);
            if (obj2 != null) {
                return obj2;
            }
            try {
    ...
    public static boolean b(Context context, String str, String str2) {
        ...
        try {
            ...
            Cursor query = context.getContentResolver().query(com.vivo.push.p.f8145c, null, "appPkgName = ? and regId = ? sdkVersion = ? ", new String[]{str, str2, "323"}, null);
            if (query == null) {
                p.a("Utility", "cursor is null");
                if (query != null) {
                    try {
