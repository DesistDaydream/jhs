...
public final class r extends z {
    ...
    public final void a(com.vivo.push.o oVar) {
        ...
        if (!com.vivo.push.util.t.d(context, context.getPackageName())) {
            ...
            hashMap.put(com.heytap.mcssdk.constant.b.f3335c, String.valueOf(qVar.f()));
        ...
        if (!isEnablePush) {
            ...
            hashMap2.put(com.heytap.mcssdk.constant.b.f3335c, String.valueOf(qVar.f()));
            ...
            hashMap3.put(com.heytap.mcssdk.constant.b.f3335c, String.valueOf(qVar.f()));
