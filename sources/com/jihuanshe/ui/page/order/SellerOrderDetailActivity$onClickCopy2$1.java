...
public final class SellerOrderDetailActivity$onClickCopy2$1 extends Lambda implements l<View, t1> {
    public final /* synthetic */ SellerOrderDetailActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SellerOrderDetailActivity$onClickCopy2$1(SellerOrderDetailActivity sellerOrderDetailActivity) {
        super(1);
    ...
    public final void invoke2(@d View view) {
        ...
        String expressNumber = value == null ? null : value.getExpressNumber();
