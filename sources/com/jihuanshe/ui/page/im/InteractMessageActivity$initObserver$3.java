...
public final class InteractMessageActivity$initObserver$3 extends Lambda implements a<t1> {
    public final /* synthetic */ InteractMessageActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InteractMessageActivity$initObserver$3(InteractMessageActivity interactMessageActivity) {
        super(0);
    ...
    public final void invoke2() {
        ...
        if (value != null && value.getNewLike().intValue() > 0) {
            value.setNewLike(Integer.valueOf(value.getNewLike().intValue() - 1));
            q0.n();
        }
    }
}
