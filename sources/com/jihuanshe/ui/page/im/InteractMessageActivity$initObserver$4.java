...
public final class InteractMessageActivity$initObserver$4 extends Lambda implements a<t1> {
    public final /* synthetic */ InteractMessageActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InteractMessageActivity$initObserver$4(InteractMessageActivity interactMessageActivity) {
        super(0);
    ...
    public final void invoke2() {
        ...
        if (value != null && value.getNewAt().intValue() > 0) {
            value.setNewAt(Integer.valueOf(value.getNewAt().intValue() - 1));
            q0.n();
        }
    }
}
