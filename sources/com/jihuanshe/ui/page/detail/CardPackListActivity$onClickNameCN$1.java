...
public final class CardPackListActivity$onClickNameCN$1 extends Lambda implements l<View, t1> {
    public final /* synthetic */ CardPackListActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CardPackListActivity$onClickNameCN$1(CardPackListActivity cardPackListActivity) {
        super(1);
    ...
    public final void invoke2(@d View view) {
        ...
        if (l0 == null || (nameCN = l0.getNameCN()) == null) {
            return;
        }
