...
public final class CardPackDetailActivity$onClickNameOrigin$1 extends Lambda implements l<View, t1> {
    public final /* synthetic */ CardPackDetailActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CardPackDetailActivity$onClickNameOrigin$1(CardPackDetailActivity cardPackDetailActivity) {
        super(1);
    ...
    public final void invoke2(@d View view) {
        ...
        if (value == null || (nameOrigin = value.getNameOrigin()) == null) {
            return;
        }
        StringUtil.a.a(nameOrigin);
    }
}
