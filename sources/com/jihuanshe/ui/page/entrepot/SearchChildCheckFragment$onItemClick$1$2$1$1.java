...
public final class SearchChildCheckFragment$onItemClick$1$2$1$1 extends Lambda implements l<t1, t1> {
    ...
    public SearchChildCheckFragment$onItemClick$1$2$1$1(SearchChildCheckFragment searchChildCheckFragment, Boolean bool, WantCard wantCard, WarehouseProductInfo warehouseProductInfo) {
        super(1);
    ...
    public final void invoke2(@e t1 t1Var) {
        this.this$0.o0(this.$isShowSold, this.$wantCard.getWishPrice(), this.$card.getWarehouseProductId());
    }
}
