...
import com.jihuanshe.ui.page.main.shop.ShopFragment$initObserver$4;
...
public final class ShopFragment$initObserver$4 extends Lambda implements l<Pair<? extends String, ? extends String>, t1> {
    public final /* synthetic */ ShopFragment this$0;

    /* renamed from: com.jihuanshe.ui.page.main.shop.ShopFragment$initObserver$4$1  reason: invalid class name */
    /* loaded from: classes2.dex */
    public static final class AnonymousClass1 extends Lambda implements l<Object, t1> {
        ...
        public static final void m23invoke$lambda0(ShopFragment shopFragment) {
            AnyKt.z(new ShopFragment$initObserver$4$1$1$1(shopFragment));
        }
        ...
        public final void invoke2(@e Object obj) {
            ...
            u0.postDelayed(new Runnable() { // from class: e.l.q.b.g.b.a
                @Override // java.lang.Runnable
                public final void run() {
                    ShopFragment$initObserver$4.AnonymousClass1.m23invoke$lambda0(ShopFragment.this);
                }
            }, 100L);
        }
    }

    /* renamed from: com.jihuanshe.ui.page.main.shop.ShopFragment$initObserver$4$2  reason: invalid class name */
    /* loaded from: classes2.dex */
    public static final class AnonymousClass2 extends Lambda implements l<Object, t1> {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* renamed from: invoke$lambda-0  reason: not valid java name */
        public static final void m24invoke$lambda0(ShopFragment shopFragment) {
            AnyKt.z(new ShopFragment$initObserver$4$2$1$1(shopFragment));
        }
        ...
        public final void invoke2(@e Object obj) {
            ListView u0 = this.this$0.u0();
            final ShopFragment shopFragment = this.this$0;
            u0.postDelayed(new Runnable() { // from class: e.l.q.b.g.b.b
                @Override // java.lang.Runnable
                public final void run() {
                    ShopFragment$initObserver$4.AnonymousClass2.m24invoke$lambda0(ShopFragment.this);
                }
            }, 100L);
        }
    }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ShopFragment$initObserver$4(ShopFragment shopFragment) {
        super(1);
        this.this$0 = shopFragment;
    }
