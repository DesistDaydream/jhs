...
public final class ShopFragment$statFilter$1 extends Lambda implements l<Pair<? extends String, ? extends String>, t1> {
    public final /* synthetic */ ShopFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ShopFragment$statFilter$1(ShopFragment shopFragment) {
        super(1);
    ...
    public final void invoke2(@d Pair<String, String> pair) {
        this.this$0.R0(STATConstant.OP_HOME_SHOP.CHANGE_SORT);
    }
}
