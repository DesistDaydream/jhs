...
public final class SellerDetailActivity$flowOfAppBar$7 extends Lambda implements l<ImageAttrs, t1> {
    public final /* synthetic */ SellerDetailActivity this$0;

    /* renamed from: com.jihuanshe.ui.page.user.SellerDetailActivity$flowOfAppBar$7$1  reason: invalid class name */
    /* loaded from: classes2.dex */
    public static final class AnonymousClass1 extends Lambda implements l<View, t1> {
        ...
        public final void invoke2(@d View view) {
            SearchActivityCreator.create(2).uid(Integer.valueOf(this.this$0.Z0())).start(this.this$0);
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SellerDetailActivity$flowOfAppBar$7(SellerDetailActivity sellerDetailActivity) {
        super(1);
        this.this$0 = sellerDetailActivity;
    }
