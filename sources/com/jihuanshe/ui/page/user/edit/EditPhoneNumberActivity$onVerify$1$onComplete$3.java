...
public final class EditPhoneNumberActivity$onVerify$1$onComplete$3 extends Lambda implements l<a, t1> {
    public final /* synthetic */ View $view;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public EditPhoneNumberActivity$onVerify$1$onComplete$3(View view) {
        super(1);
        this.$view = view;
    }
