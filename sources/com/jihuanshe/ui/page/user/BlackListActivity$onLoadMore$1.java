...
public final class BlackListActivity$onLoadMore$1 extends Lambda implements p<g<?>, LoadMore.State, t1> {
    public final /* synthetic */ BlackListActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BlackListActivity$onLoadMore$1(BlackListActivity blackListActivity) {
        super(2);
    ...
    public final void invoke2(@d g<?> gVar, @d LoadMore.State state) {
        BinderKt.d(((BlackListViewModel) this.this$0.L()).r0(state), this.this$0, gVar, true);
    }
}
