...
public final class SearchProductFragment$flowOfSetup$4 extends Lambda implements l<String, t1> {
    public final /* synthetic */ SearchProductFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SearchProductFragment$flowOfSetup$4(SearchProductFragment searchProductFragment) {
        super(1);
