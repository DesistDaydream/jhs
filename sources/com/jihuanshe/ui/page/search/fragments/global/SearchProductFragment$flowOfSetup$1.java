...
public final class SearchProductFragment$flowOfSetup$1 extends Lambda implements l<String, t1> {
    public final /* synthetic */ SearchProductFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SearchProductFragment$flowOfSetup$1(SearchProductFragment searchProductFragment) {
        super(1);
    ...
    public final void invoke2(@d String str) {
        ...
        if (f0.g(q0.r0().getValue(), this.this$0.k0())) {
            ((SearchProductViewModel) this.this$0.T()).w0(str);
            this.this$0.s0();
        }
    }
}
