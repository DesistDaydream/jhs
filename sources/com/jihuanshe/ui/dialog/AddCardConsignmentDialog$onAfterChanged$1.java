...
public final class AddCardConsignmentDialog$onAfterChanged$1 extends Lambda implements l<Editable, t1> {
    public final /* synthetic */ AddCardConsignmentDialog this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AddCardConsignmentDialog$onAfterChanged$1(AddCardConsignmentDialog addCardConsignmentDialog) {
        super(1);
    ...
    public final void invoke2(@d Editable editable) {
        ...
        try {
            ...
            if (Integer.parseInt(editable.toString()) <= 0) {
                addCardConsignmentDialog.getCount().setValue(1);
            } else {
                addCardConsignmentDialog.getCount().setValue(Integer.valueOf(Integer.parseInt(editable.toString())));
            }
