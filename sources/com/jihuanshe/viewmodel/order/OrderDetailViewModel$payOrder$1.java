...
public final class OrderDetailViewModel$payOrder$1 extends Lambda implements l<PayParams, t1> {
    public static final OrderDetailViewModel$payOrder$1 INSTANCE = new OrderDetailViewModel$payOrder$1();

    public OrderDetailViewModel$payOrder$1() {
        super(1);
    }
