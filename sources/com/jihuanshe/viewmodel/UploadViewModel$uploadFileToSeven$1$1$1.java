...
public final class UploadViewModel$uploadFileToSeven$1$1$1 extends Lambda implements l<UploadInfo, t1> {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements p<n0, c<? super t1>, Object> {
        ...
        /* renamed from: com.jihuanshe.viewmodel.UploadViewModel$uploadFileToSeven$1$1$1$1$1  reason: invalid class name and collision with other inner class name */
        /* loaded from: classes2.dex */
        public static final class C01401 extends Lambda implements l<String, t1> {
            public final /* synthetic */ n<FileInfo> $continuation;
            public final /* synthetic */ Uri $uri;
            public final /* synthetic */ UploadViewModel this$0;
            ...
            public C01401(UploadViewModel uploadViewModel, n<? super FileInfo> nVar, Uri uri) {
                super(1);
            ...
            public final void invoke2(@e String str) {
                ...
                FileInfo fileInfo = new FileInfo("", str, this.$uri, null, 8, null);
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public AnonymousClass1(Uri uri, UploadInfo uploadInfo, UploadViewModel uploadViewModel, n<? super FileInfo> nVar, c<? super AnonymousClass1> cVar) {
            super(2, cVar);
            this.$uri = uri;
            this.$it = uploadInfo;
            this.this$0 = uploadViewModel;
        ...
        public final c<t1> create(@e Object obj, @d c<?> cVar) {
            return new AnonymousClass1(this.$uri, this.$it, this.this$0, this.$continuation, cVar);
        }
        ...
        public final Object invokeSuspend(@d Object obj) {
            ...
            if (this.label == 0) {
                ...
                l0Var.c(uri, url, token != null ? token : "", new C01401(this.this$0, this.$continuation, this.$uri));
                return t1.a;
            }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public UploadViewModel$uploadFileToSeven$1$1$1(UploadViewModel uploadViewModel, Uri uri, n<? super FileInfo> nVar) {
        super(1);
        this.this$0 = uploadViewModel;
        this.$uri = uri;
        this.$continuation = nVar;
    ...
    public final void invoke2(@e UploadInfo uploadInfo) {
        i.f(ViewModelKt.getViewModelScope(this.this$0), b1.c(), null, new AnonymousClass1(this.$uri, uploadInfo, this.this$0, this.$continuation, null), 2, null);
    }
}
