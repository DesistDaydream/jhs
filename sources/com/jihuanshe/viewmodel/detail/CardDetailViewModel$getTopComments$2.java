...
public final class CardDetailViewModel$getTopComments$2 extends Lambda implements l<e<TopCommentInfo>, t1> {
    public final /* synthetic */ CardDetailViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CardDetailViewModel$getTopComments$2(CardDetailViewModel cardDetailViewModel) {
        super(1);
    ...
    public final void invoke2(@k.e.a.e e<TopCommentInfo> eVar) {
        Integer e2;
        String str;
        this.this$0.W0().setValue(eVar == null ? null : eVar.b());
        boolean z = false;
        int intValue = (eVar == null || (e2 = eVar.e()) == null) ? 0 : e2.intValue();
        this.this$0.Y0().setValue(Boolean.valueOf(intValue != 0));
        p X0 = this.this$0.X0();
