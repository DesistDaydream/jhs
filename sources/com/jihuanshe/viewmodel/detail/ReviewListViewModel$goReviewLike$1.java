...
public final class ReviewListViewModel$goReviewLike$1 extends Lambda implements l<t1, t1> {
    public final /* synthetic */ boolean $isMine;
    public final /* synthetic */ ReviewListViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ReviewListViewModel$goReviewLike$1(boolean z, ReviewListViewModel reviewListViewModel) {
        super(1);
        this.$isMine = z;
