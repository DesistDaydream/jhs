...
public final class SearchUserViewModel$handleFollow$2 extends Lambda implements l<t1, t1> {
    public final /* synthetic */ SearchUser $user;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SearchUserViewModel$handleFollow$2(SearchUser searchUser) {
        super(1);
