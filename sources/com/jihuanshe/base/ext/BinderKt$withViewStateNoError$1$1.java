...
public final class BinderKt$withViewStateNoError$1$1 extends Lambda implements l<NLive.State, t1> {
    public final /* synthetic */ SimpleFragEx $act;
    ...
    public BinderKt$withViewStateNoError$1$1(SimpleFragEx simpleFragEx) {
        super(1);
        this.$act = simpleFragEx;
    }
    ...
    public final void invoke2(@d NLive.State state) {
        ViewState viewState;
        SimpleFragEx simpleFragEx = this.$act;
