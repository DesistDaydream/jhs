...
public final class AppBarKt$addBackBlackIcon$1 extends Lambda implements l<ImageAttrs, t1> {
    ...
    /* renamed from: com.jihuanshe.base.ext.AppBarKt$addBackBlackIcon$1$1  reason: invalid class name */
    /* loaded from: classes2.dex */
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AppBarKt$addBackBlackIcon$1(int i2, a<Boolean> aVar, Activity activity) {
        super(1);
        this.$back = i2;
        this.$block = aVar;
        this.$activity = activity;
