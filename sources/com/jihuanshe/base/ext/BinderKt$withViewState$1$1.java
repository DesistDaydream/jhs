...
public final class BinderKt$withViewState$1$1 extends Lambda implements l<NLive.State, t1> {
    public final /* synthetic */ SimpleActivityEx $act;
    ...
    public BinderKt$withViewState$1$1(SimpleActivityEx simpleActivityEx) {
        super(1);
        this.$act = simpleActivityEx;
    }
    ...
    public final void invoke2(@d NLive.State state) {
        ViewState viewState;
        SimpleActivityEx simpleActivityEx = this.$act;
