...
public final class BaseBus$BusObserver$onNullableValue$1 extends Lambda implements l<BaseBus.b<?>, t1> {
    public final /* synthetic */ l<T, t1> $block;
    public final /* synthetic */ String $eventId;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public BaseBus$BusObserver$onNullableValue$1(String str, l<? super T, t1> lVar) {
        super(1);
        this.$eventId = str;
        this.$block = lVar;
    }
