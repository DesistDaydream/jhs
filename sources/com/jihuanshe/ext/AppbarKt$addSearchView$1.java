...
public final class AppbarKt$addSearchView$1 extends Lambda implements l<ImageAttrs, t1> {
    public final /* synthetic */ a<t1> $block;
    public final /* synthetic */ int $endDp;

    /* renamed from: com.jihuanshe.ext.AppbarKt$addSearchView$1$1  reason: invalid class name */
    /* loaded from: classes2.dex */
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AppbarKt$addSearchView$1(int i2, a<t1> aVar) {
        super(1);
        this.$endDp = i2;
        this.$block = aVar;
    }
