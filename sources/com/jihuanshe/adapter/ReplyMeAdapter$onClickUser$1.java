...
public final class ReplyMeAdapter$onClickUser$1 extends Lambda implements l<View, t1> {
    public static final ReplyMeAdapter$onClickUser$1 INSTANCE = new ReplyMeAdapter$onClickUser$1();

    public ReplyMeAdapter$onClickUser$1() {
        super(1);
    }
