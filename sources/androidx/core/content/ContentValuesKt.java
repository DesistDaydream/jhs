...
public final class ContentValuesKt {
    @d
    public static final ContentValues contentValuesOf(@d Pair<String, ? extends Object>... pairArr) {
        ...
        while (i2 < length) {
            ...
            if (component2 == null) {
                ...
                throw new IllegalArgumentException("Illegal value type " + ((Object) canonicalName) + " for key \"" + component1 + y.a);
            } else {
