    ...
    public static Action getActionCompatFromAction(@NonNull Notification.Action action) {
        ...
        if (remoteInputs == null) {
            ...
            for (int i5 = 0; i5 < remoteInputs.length; i5++) {
                ...
                remoteInputArr2[i5] = new RemoteInput(remoteInput.getResultKey(), remoteInput.getLabel(), remoteInput.getChoices(), remoteInput.getAllowFreeFormInput(), i4 >= 29 ? remoteInput.getEditChoicesBeforeSending() : 0, remoteInput.getExtras(), null);
            }
        ...
        if (i4 >= 23) {
            ...
            return new Action(action.getIcon() != null ? IconCompat.createFromIconOrNullIfZeroResId(action.getIcon()) : null, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, i6, z3, isContextual);
        }
