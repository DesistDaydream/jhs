...
public class NotificationCompatBuilder implements NotificationBuilderWithBuilderAccessor {
    ...
    public NotificationCompatBuilder(NotificationCompat.Builder builder) {
        ...
        if (BuildCompat.isAtLeastS() && (i2 = builder.mFgsDeferBehavior) != 0) {
    ...
    public Notification build() {
        ...
        if (i2 >= 21 && style != null && (makeHeadsUpContentView = this.mBuilderCompat.mStyle.makeHeadsUpContentView(this)) != null) {
            buildInternal.headsUpContentView = makeHeadsUpContentView;
        }
        if (i2 >= 16 && style != null && (extras = NotificationCompat.getExtras(buildInternal)) != null) {
