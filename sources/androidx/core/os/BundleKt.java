...
public final class BundleKt {
    @d
    public static final Bundle bundleOf(@d Pair<String, ? extends Object>... pairArr) {
        ...
        while (i2 < length) {
            ...
            if (component2 == null) {
                ...
                if (i3 >= 18 && (component2 instanceof IBinder)) {
                    bundle.putBinder(component1, (IBinder) component2);
                } else if (i3 >= 21 && (component2 instanceof Size)) {
                    bundle.putSize(component1, (Size) component2);
                } else if (i3 >= 21 && (component2 instanceof SizeF)) {
