...
public final class PersistableBundleKt {
    @RequiresApi(21)
    @d
    public static final PersistableBundle persistableBundleOf(@d Pair<String, ? extends Object>... pairArr) {
        int i2 = Build.VERSION.SDK_INT;
        PersistableBundle persistableBundle = new PersistableBundle(pairArr.length);
        int length = pairArr.length;
        int i3 = 0;
        while (i3 < length) {
            Pair<String, ? extends Object> pair = pairArr[i3];
            i3++;
            ...
            if (component2 == null) {
                ...
                if (i2 >= 22) {
                    ...
                    throw new IllegalArgumentException("Illegal value type boolean for key \"" + component1 + y.a);
                }
                ...
                if (String.class.isAssignableFrom(componentType)) {
                    ...
                    throw new IllegalArgumentException("Illegal value array type " + ((Object) canonicalName) + " for key \"" + component1 + y.a);
                }
            } else {
                String canonicalName2 = component2.getClass().getCanonicalName();
                throw new IllegalArgumentException("Illegal value type " + ((Object) canonicalName2) + " for key \"" + component1 + y.a);
            }
        }
