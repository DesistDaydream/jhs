...
public final class SparseIntArrayKt {
    ...
    public static final void forEach(@d SparseIntArray sparseIntArray, @d p<? super Integer, ? super Integer, t1> pVar) {
    ...
    @d
    public static final l0 keyIterator(@d final SparseIntArray sparseIntArray) {
        return new l0() { // from class: androidx.core.util.SparseIntArrayKt$keyIterator$1
            private int index;
    ...
    @d
    public static final l0 valueIterator(@d final SparseIntArray sparseIntArray) {
        return new l0() { // from class: androidx.core.util.SparseIntArrayKt$valueIterator$1
            private int index;
