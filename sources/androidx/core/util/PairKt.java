...
public final class PairKt {
    ...
    public static final <F, S> F component1(@d Pair<F, S> pair) {
        return pair.first;
    }

    @SuppressLint({"UnknownNullness"})
    public static final <F, S> S component2(@d Pair<F, S> pair) {
        return pair.second;
    }

    @d
    public static final <F, S> android.util.Pair<F, S> toAndroidPair(@d kotlin.Pair<? extends F, ? extends S> pair) {
        return new android.util.Pair<>(pair.getFirst(), pair.getSecond());
    }

    @d
    public static final <F, S> Pair<F, S> toAndroidXPair(@d kotlin.Pair<? extends F, ? extends S> pair) {
        return new Pair<>(pair.getFirst(), pair.getSecond());
    }

    @d
    public static final <F, S> kotlin.Pair<F, S> toKotlinPair(@d Pair<F, S> pair) {
    ...
    @d
    public static final <F, S> kotlin.Pair<F, S> toKotlinPair(@d android.util.Pair<F, S> pair) {
        return new kotlin.Pair<>(pair.first, pair.second);
    }
}
