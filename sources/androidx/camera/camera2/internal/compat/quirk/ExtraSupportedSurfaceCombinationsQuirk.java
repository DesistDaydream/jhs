...
public class ExtraSupportedSurfaceCombinationsQuirk implements Quirk {
    ...
    @NonNull
    private List<SurfaceCombination> getLimitedDeviceExtraSupportedFullConfigurations(int i2) {
    ...
    @NonNull
    public List<SurfaceCombination> getExtraSupportedSurfaceCombinations(@NonNull String str, int i2) {
        if (isSamsungS7()) {
            return getSamsungS7ExtraCombinations(str);
        }
        if (supportExtraFullConfigurationsSamsungDevice()) {
            return getLimitedDeviceExtraSupportedFullConfigurations(i2);
        }
