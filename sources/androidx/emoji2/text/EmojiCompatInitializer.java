...
public class EmojiCompatInitializer implements Initializer<Boolean> {
    ...
    public static class BackgroundDefaultLoader implements EmojiCompat.MetadataRepoLoader {
        ...
        @WorkerThread
        /* renamed from: doLoad */
        public void b(@NonNull final EmojiCompat.MetadataRepoLoaderCallback metadataRepoLoaderCallback, @NonNull final ThreadPoolExecutor threadPoolExecutor) {
            try {
        ...
        public void load(@NonNull final EmojiCompat.MetadataRepoLoaderCallback metadataRepoLoaderCallback) {
            ...
            createBackgroundPriorityExecutor.execute(new Runnable() { // from class: c.e.a.c
                {
                ...
                public final void run() {
                    EmojiCompatInitializer.BackgroundDefaultLoader.this.b(metadataRepoLoaderCallback, createBackgroundPriorityExecutor);
                }
            });
        }
    }
