...
public final class Utf8Safe extends Utf8 {
    ...
    private static int computeEncodedLength(CharSequence charSequence) {
        ...
        throw new IllegalArgumentException("UTF-8 length does not fit in int: " + (i3 + SVG.T));
    }
        ...
        if ((i2 | i3 | ((byteBuffer.limit() - i2) - i3)) >= 0) {
            ...
            while (i2 < i4) {
                ...
                if (Utf8.DecodeUtil.isOneByte(b2)) {
                    ...
                    if (i7 < i4 - 1) {
                        int i9 = i7 + 1;
                        Utf8.DecodeUtil.handleThreeBytes(b2, byteBuffer.get(i7), byteBuffer.get(i9), cArr, i6);
                        i2 = i9 + 1;
                        i6++;
                    } else {
                        throw new IllegalArgumentException("Invalid UTF-8");
                    ...
                    int i11 = i10 + 1;
                    Utf8.DecodeUtil.handleFourBytes(b2, b4, byteBuffer.get(i10), byteBuffer.get(i11), cArr, i6);
                    i2 = i11 + 1;
                    i6 = i6 + 1 + 1;
                } else {
                    throw new IllegalArgumentException("Invalid UTF-8");
        ...
        while (i2 < length) {
            ...
            if (charAt2 < 128) {
                ...
                try {
                    ...
                    byteBuffer.put(i3, (byte) ((charAt2 & e.a) | 128));
                    position = i3;
                ...
                byteBuffer.put(position, (byte) ((charAt2 & e.a) | 128));
            }
            i2++;
            position++;
        }
