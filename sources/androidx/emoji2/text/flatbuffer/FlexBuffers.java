...
public class FlexBuffers {
    ...
    public static class Reference {
        ...
        public String asString() {
            if (isString()) {
                ...
                return this.bb.getString(indirect, (int) FlexBuffers.readUInt(readBuf, indirect - i2, i2));
            } else if (isKey()) {
                ...
                return this.bb.getString(indirect2, i3 - indirect2);
            } else {
                return "";
            }
        }
    ...
    public static Reference getRoot(ReadBuf readBuf) {
        ...
        int i2 = limit - 1;
        return new Reference(readBuf, i2 - b, b, Unsigned.byteToUnsignedInt(readBuf.get(i2)));
    }
}
