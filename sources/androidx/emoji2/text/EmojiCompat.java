...
public class EmojiCompat {
    ...
    public static class CompatInternal {
        ...
        public CharSequence process(@NonNull CharSequence charSequence, @IntRange(from = 0) int i2, @IntRange(from = 0) int i3, @IntRange(from = 0) int i4, boolean z) {
            return charSequence;
        }
    ...
    public static final class CompatInternal19 extends CompatInternal {
        ...
        @Override // androidx.emoji2.text.EmojiCompat.CompatInternal
        public CharSequence process(@NonNull CharSequence charSequence, int i2, int i3, int i4, boolean z) {
            return this.mProcessor.process(charSequence, i2, i3, i4, z);
        }
        ...
        public boolean hasEmojiGlyph(@NonNull CharSequence charSequence, int i2) {
            ...
            return emojiMetadata != null && emojiMetadata.getCompatAdded() <= i2;
        }
    }
        ...
        public Config setUseEmojiAsDefaultStyle(boolean z, @Nullable List<Integer> list) {
            ...
            if (z && list != null) {
                ...
                for (Integer num : list) {
                    this.mEmojiAsDefaultStyleExceptions[i2] = num.intValue();
                    i2++;
                }
