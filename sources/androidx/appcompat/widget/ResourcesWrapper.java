...
public class ResourcesWrapper extends Resources {
    ...
    public final Drawable getDrawableCanonical(int i2) throws Resources.NotFoundException {
    ...
    public void getValueForDensity(int i2, int i3, TypedValue typedValue, boolean z) throws Resources.NotFoundException {
        Compatibility.Api15Impl.getValueForDensity(this.mResources, i2, i3, typedValue, z);
    }
