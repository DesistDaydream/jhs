...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    private boolean onKeyUpPanel(int i2, KeyEvent keyEvent) {
        ...
        if (z2) {
            AudioManager audioManager = (AudioManager) this.mContext.getApplicationContext().getSystemService(TUIConstants.TUICalling.TYPE_AUDIO);
    ...
    */
    ...
    public class AppCompatWindowCallback extends WindowCallbackWrapper {
        ...
        public boolean onPreparePanel(int i2, View view, Menu menu) {
            ...
            ActionBarMenuCallback actionBarMenuCallback = this.mActionBarCallback;
            z = (actionBarMenuCallback == null || !actionBarMenuCallback.onPreparePanel(i2)) ? false : false;
            if (!z) {
