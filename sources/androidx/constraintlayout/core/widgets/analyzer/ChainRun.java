...
public class ChainRun extends WidgetRun {
    ...
    public long getWrapDimension() {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            WidgetRun widgetRun = this.widgets.get(i2);
            j2 = j2 + widgetRun.start.margin + widgetRun.getWrapDimension() + widgetRun.end.margin;
        }
        return j2;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:599:0x0402, code lost:
        r7 = r7 - r10;
     */
    /* JADX WARN: Removed duplicated region for block: B:390:0x00d7  */
    /* JADX WARN: Removed duplicated region for block: B:393:0x00e9  */
