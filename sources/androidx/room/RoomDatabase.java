...
public abstract class RoomDatabase {
        ...
        public T build() {
            ...
            if (this.mContext != null) {
                if (this.mDatabaseClass != null) {
                    ...
                    long j2 = this.mAutoCloseTimeout;
                    if (j2 > 0) {
                        if (this.mName != null) {
                            autoClosingRoomOpenHelperFactory = new AutoClosingRoomOpenHelperFactory(autoClosingRoomOpenHelperFactory, new AutoCloser(j2, this.mAutoCloseTimeUnit, this.mTransactionExecutor));
                        } else {
    ...
    public void beginTransaction() {
        ...
        if (autoCloser == null) {
            ...
            autoCloser.executeRefCountingFunction(new Function() { // from class: c.g.p0
    ...
    public void endTransaction() {
        ...
        if (autoCloser == null) {
            ...
            autoCloser.executeRefCountingFunction(new Function() { // from class: c.g.q0
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
    ...
    public void init(@NonNull DatabaseConfiguration configuration) {
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            r2 = configuration.journalMode == JournalMode.WRITE_AHEAD_LOGGING;
