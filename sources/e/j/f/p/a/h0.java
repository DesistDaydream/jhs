...
public final class h0 extends t {
    ...
    private static final Pattern f11422f = Pattern.compile("[IOQ]");

    /* renamed from: g  reason: collision with root package name */
    private static final Pattern f11423g = Pattern.compile("[A-Z0-9]{17}");
            ...
            if (c2 < 'J' || c2 > 'N') {
                ...
                if (c2 < 'R' || c2 > 'T') {
                    if (c2 < 'V' || c2 > 'Y') {
                        ...
                        return (c2 - '1') + ErrorCode.INIT_ERROR;
                    }
                    return (c2 - 'V') + 1997;
                }
                return (c2 - 'R') + 1994;
    ...
    /* renamed from: u */
    public g0 k(e.j.f.k kVar) {
        if (kVar.b() != BarcodeFormat.CODE_39) {
            return null;
        }
        String trim = f11422f.matcher(kVar.g()).replaceAll("").trim();
        if (f11423g.matcher(trim).matches()) {
            try {
                if (r(trim)) {
