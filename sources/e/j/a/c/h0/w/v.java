...
public class v {
    ...
    private static final String f10835c = "cubic-bezier";

    /* renamed from: d  reason: collision with root package name */
    private static final String f10836d = "path";

    /* renamed from: e  reason: collision with root package name */
    private static final String f10837e = "(";

    /* renamed from: f  reason: collision with root package name */
    private static final String f10838f = ")";

    /* renamed from: g  reason: collision with root package name */
    private static final int f10839g = 0;

    /* renamed from: h  reason: collision with root package name */
    private static final int f10840h = 1;

    /* renamed from: i  reason: collision with root package name */
    private static final RectF f10841i = new RectF();
    ...
    public static class b implements d {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final /* synthetic */ float f10842c;

        /* renamed from: d  reason: collision with root package name */
        public final /* synthetic */ float f10843d;

        /* renamed from: e  reason: collision with root package name */
        public final /* synthetic */ float f10844e;
        ...
        @Override // e.j.a.c.h0.w.v.d
        @NonNull
        public e.j.a.c.z.d a(@NonNull e.j.a.c.z.d dVar, @NonNull e.j.a.c.z.d dVar2) {
            return new e.j.a.c.z.a(v.o(dVar.a(this.a), dVar2.a(this.b), this.f10842c, this.f10843d, this.f10844e));
        }
    }
    ...
    private static boolean l(String str, String str2) {
        ...
        sb.append(str2);
        sb.append(f10837e);
        return str.startsWith(sb.toString()) && str.endsWith(f10838f);
    }
    ...
    public static TimeInterpolator x(Context context, @AttrRes int i2, @NonNull TimeInterpolator timeInterpolator) {
        ...
        if (context.getTheme().resolveAttribute(i2, typedValue, true)) {
            if (typedValue.type == 3) {
                ...
                if (l(valueOf, f10835c)) {
                    String[] split = h(valueOf, f10835c).split(Constants.ACCEPT_TIME_SEPARATOR_SP);
                    if (split.length == 4) {
                        return PathInterpolatorCompat.create(g(split, 0), g(split, 1), g(split, 2), g(split, 3));
                    }
                    throw new IllegalArgumentException("Motion easing theme attribute must have 4 control points if using bezier curve format; instead got: " + split.length);
                } else if (l(valueOf, f10836d)) {
                    return PathInterpolatorCompat.create(PathParser.createPathFromPathData(h(valueOf, f10836d)));
                } else {
