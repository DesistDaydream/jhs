...
public class g {
    ...
    public static class a implements f {
        ...
        public boolean b(h hVar) {
            return hVar.f10774d > hVar.f10776f;
        }

        @Override // e.j.a.c.h0.w.f
        public void c(RectF rectF, float f2, h hVar) {
            rectF.bottom -= Math.abs(hVar.f10776f - hVar.f10774d) * f2;
        }
    }
    ...
    public static class b implements f {
        @Override // e.j.a.c.h0.w.f
        public h a(float f2, float f3, float f4, float f5, float f6, float f7, float f8) {
            float p = v.p(f6, f8, f3, f4, f2, true);
            float f9 = p / f6;
            float f10 = p / f8;
        ...
        @Override // e.j.a.c.h0.w.f
        public boolean b(h hVar) {
            return hVar.f10773c > hVar.f10775e;
        }

        @Override // e.j.a.c.h0.w.f
        public void c(RectF rectF, float f2, h hVar) {
            float abs = (Math.abs(hVar.f10775e - hVar.f10773c) / 2.0f) * f2;
            rectF.left += abs;
            rectF.right -= abs;
        }
    }
