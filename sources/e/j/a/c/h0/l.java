...
public final class l extends Transition {
    ...
    public class b extends t {
        ...
        @Override // e.j.a.c.h0.t, androidx.transition.Transition.TransitionListener
        public void onTransitionEnd(@NonNull Transition transition) {
            l.this.removeListener(this);
            if (l.this.b) {
                return;
            }
            this.f10714c.setAlpha(1.0f);
            this.f10715d.setAlpha(1.0f);
        ...
        public void onTransitionStart(@NonNull Transition transition) {
            ...
            this.f10714c.setAlpha(0.0f);
            this.f10715d.setAlpha(0.0f);
        }
    }
    ...
    public static final class h extends Drawable {
        ...
        private final f A;
        private final e.j.a.c.h0.a B;
        private final e.j.a.c.h0.f C;
        private final boolean D;
        private final Paint E;
        private final Path F;
        private e.j.a.c.h0.c G;
        private e.j.a.c.h0.h H;
        private RectF I;
        private float J;
        private float K;
        private float L;
        ...
        /* renamed from: c  reason: collision with root package name */
        private final e.j.a.c.z.o f10719c;

        /* renamed from: d  reason: collision with root package name */
        private final float f10720d;

        /* renamed from: e  reason: collision with root package name */
        private final View f10721e;

        /* renamed from: f  reason: collision with root package name */
        private final RectF f10722f;

        /* renamed from: g  reason: collision with root package name */
        private final e.j.a.c.z.o f10723g;

        /* renamed from: h  reason: collision with root package name */
        private final float f10724h;

        /* renamed from: i  reason: collision with root package name */
        private final Paint f10725i;

        /* renamed from: j  reason: collision with root package name */
        private final Paint f10726j;

        /* renamed from: k  reason: collision with root package name */
        private final Paint f10727k;

        /* renamed from: l  reason: collision with root package name */
        private final Paint f10728l;

        /* renamed from: m  reason: collision with root package name */
        private final Paint f10729m;
        private final j n;
        ...
        public class b implements u.c {
            ...
            @Override // e.j.a.c.h0.u.c
            public void a(Canvas canvas) {
                h.this.f10721e.draw(canvas);
            }
        }

        public /* synthetic */ h(PathMotion pathMotion, View view, RectF rectF, e.j.a.c.z.o oVar, float f2, View view2, RectF rectF2, e.j.a.c.z.o oVar2, float f3, int i2, int i3, int i4, int i5, boolean z, boolean z2, e.j.a.c.h0.a aVar, e.j.a.c.h0.f fVar, f fVar2, boolean z3, a aVar2) {
        ...
        private void j(Canvas canvas) {
            ...
            if (c2.u(this.I)) {
                ...
                canvas.drawRoundRect(this.I, a2, a2, this.f10728l);
                return;
            }
            canvas.drawPath(this.n.d(), this.f10728l);
        }

        private void k(Canvas canvas) {
            n(canvas, this.f10727k);
        ...
        private void p(float f2) {
            ...
            float f4;
            this.L = f2;
            this.f10729m.setAlpha((int) (this.r ? u.n(0.0f, 255.0f, f2) : u.n(255.0f, 0.0f, f2)));
            ...
            float f7 = f5;
            float f8 = f6;
            e.j.a.c.h0.h a2 = this.C.a(f2, ((Float) Preconditions.checkNotNull(Float.valueOf(this.A.b.a))).floatValue(), ((Float) Preconditions.checkNotNull(Float.valueOf(this.A.b.b))).floatValue(), this.b.width(), this.b.height(), this.f10722f.width(), this.f10722f.height());
            this.H = a2;
            RectF rectF = this.w;
            float f9 = a2.f10696c;
            rectF.set(f7 - (f9 / 2.0f), f8, (f9 / 2.0f) + f7, a2.f10697d + f8);
            RectF rectF2 = this.y;
            e.j.a.c.h0.h hVar = this.H;
            float f10 = hVar.f10698e;
            rectF2.set(f7 - (f10 / 2.0f), f8, f7 + (f10 / 2.0f), hVar.f10699f + f8);
            this.x.set(this.w);
            this.z.set(this.y);
            float floatValue = ((Float) Preconditions.checkNotNull(Float.valueOf(this.A.f10717c.a))).floatValue();
            float floatValue2 = ((Float) Preconditions.checkNotNull(Float.valueOf(this.A.f10717c.b))).floatValue();
            ...
            this.n.b(f2, this.f10719c, this.f10723g, this.w, this.x, this.z, this.A.f10718d);
            this.J = u.n(this.f10720d, this.f10724h, f2);
            float d2 = d(this.I, this.s);
            float e2 = e(this.I, this.t);
            float f11 = this.J;
            float f12 = (int) (e2 * f11);
            this.K = f12;
            this.f10728l.setShadowLayer(f11, (int) (d2 * f11), f12, M);
            ...
            if (this.f10726j.getColor() != 0) {
                this.f10726j.setAlpha(this.G.a);
            }
            if (this.f10727k.getColor() != 0) {
                this.f10727k.setAlpha(this.G.b);
            }
            invalidateSelf();
        }
        ...
        public void draw(@NonNull Canvas canvas) {
            if (this.f10729m.getAlpha() > 0) {
                canvas.drawRect(getBounds(), this.f10729m);
            }
        ...
        private h(PathMotion pathMotion, View view, RectF rectF, e.j.a.c.z.o oVar, float f2, View view2, RectF rectF2, e.j.a.c.z.o oVar2, float f3, @ColorInt int i2, @ColorInt int i3, @ColorInt int i4, int i5, boolean z, boolean z2, e.j.a.c.h0.a aVar, e.j.a.c.h0.f fVar, f fVar2, boolean z3) {
    ...
    public l() {
        ...
        this.f10703c = false;
        this.f10704d = false;
        this.f10705e = 16908290;
        this.f10706f = -1;
        this.f10707g = -1;
        this.f10708h = 0;
        this.f10709i = 0;
        this.f10710j = 0;
        this.f10711k = 1375731712;
        this.f10712l = 0;
        this.f10713m = 0;
        this.n = 0;
    ...
    private f C(boolean z2, f fVar, f fVar2) {
        ...
        return new f((e) u.d(this.s, fVar.a), (e) u.d(this.t, fVar.b), (e) u.d(this.u, fVar.f10717c), (e) u.d(this.v, fVar.f10718d), null);
    }
    ...
    private boolean H(@NonNull RectF rectF, @NonNull RectF rectF2) {
        ...
        if (i2 == 0) {
            ...
            throw new IllegalArgumentException("Invalid transition direction: " + this.f10712l);
        } else {
            return true;
        }
    }
    ...
    private void J(Context context, boolean z2) {
        u.u(this, context, R.attr.motionEasingStandard, e.j.a.c.a.a.b);
        u.t(this, context, z2 ? R.attr.motionDurationLong1 : R.attr.motionDurationMedium2);
        if (this.f10703c) {
            return;
        }
        u.v(this, context, R.attr.motionPath);
    }
    ...
    public void captureEndValues(@NonNull TransitionValues transitionValues) {
        f(transitionValues, this.p, this.f10707g, this.r);
    }

    @Override // androidx.transition.Transition
    public void captureStartValues(@NonNull TransitionValues transitionValues) {
        f(transitionValues, this.o, this.f10706f, this.q);
    }
        ...
        if (transitionValues != null && transitionValues2 != null) {
            ...
            if (rectF != null && oVar != null) {
                ...
                if (rectF2 != null && oVar2 != null) {
                    ...
                    if (this.f10705e == view4.getId()) {
                        e2 = (View) view4.getParent();
                        view = view4;
                    } else {
                        e2 = u.e(view4, this.f10705e);
                        view = null;
                    }
                    RectF i2 = u.i(e2);
                    float f2 = -i2.left;
                    ...
                    h hVar = new h(getPathMotion(), view2, rectF, oVar, j(this.x, view2), view3, rectF2, oVar2, j(this.y, view3), this.f10708h, this.f10709i, this.f10710j, this.f10711k, H2, this.w, e.j.a.c.h0.b.a(this.f10713m, H2), e.j.a.c.h0.g.a(this.n, H2, rectF, rectF2), b(H2), this.a, null);
