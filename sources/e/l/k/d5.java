...
public class d5 extends c5 {
    ...
    */
    public void executeBindings() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: e.l.k.d5.executeBindings():void");
    }

    @Override // e.l.k.c5
    public void h(@Nullable BaseUploadInfoDialogFragment baseUploadInfoDialogFragment) {
        this.n = baseUploadInfoDialogFragment;
        synchronized (this) {
            this.u |= 16;
        }
    ...
    public boolean setVariable(int i2, @Nullable Object obj) {
        if (10 == i2) {
            h((BaseUploadInfoDialogFragment) obj);
            return true;
        }
        return false;
    }
    ...
    private d5(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        ...
        this.u = -1L;
        this.f12396c.setTag(null);
        this.f12397d.setTag(null);
        this.f12398e.setTag(null);
        this.f12399f.setTag(null);
        this.f12400g.setTag(null);
        this.f12401h.setTag(null);
        this.f12402i.setTag(null);
        this.f12403j.setTag(null);
        ...
        this.f12404k.setTag(null);
        this.f12405l.setTag(null);
        this.f12406m.setTag(null);
        setRootTag(view);
        invalidateAll();
    }
}
