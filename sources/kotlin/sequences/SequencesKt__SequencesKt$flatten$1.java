...
public final class SequencesKt__SequencesKt$flatten$1 extends Lambda implements l<m<? extends T>, Iterator<? extends T>> {
    ...
    @Override // h.k2.u.l
    @d
    public final Iterator<T> invoke(@d m<? extends T> mVar) {
