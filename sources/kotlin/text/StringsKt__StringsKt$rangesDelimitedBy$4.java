...
public final class StringsKt__StringsKt$rangesDelimitedBy$4 extends Lambda implements p<CharSequence, Integer, Pair<? extends Integer, ? extends Integer>> {
    ...
    public final Pair<Integer, Integer> invoke(@d CharSequence charSequence, int i2) {
        Pair d3;
        d3 = StringsKt__StringsKt.d3(charSequence, this.$delimitersList, i2, this.$ignoreCase, false);
        if (d3 != null) {
            return z0.a(d3.getFirst(), Integer.valueOf(((String) d3.getSecond()).length()));
        }
        return null;
    }
}
