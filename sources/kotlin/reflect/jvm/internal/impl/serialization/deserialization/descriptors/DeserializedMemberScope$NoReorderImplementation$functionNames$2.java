...
public final class DeserializedMemberScope$NoReorderImplementation$functionNames$2 extends Lambda implements a<Set<? extends f>> {
    ...
    public final Set<? extends f> invoke() {
        ...
        for (n nVar : list) {
            linkedHashSet.add(q.b(deserializedMemberScope.b.g(), ((ProtoBuf.Function) nVar).getName()));
        }
        return e1.C(linkedHashSet, this.this$1.v());
    }
}
