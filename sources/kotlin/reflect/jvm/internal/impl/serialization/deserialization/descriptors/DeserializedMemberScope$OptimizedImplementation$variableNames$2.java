...
public final class DeserializedMemberScope$OptimizedImplementation$variableNames$2 extends Lambda implements a<Set<? extends f>> {
    ...
    public final Set<? extends f> invoke() {
        Map map;
        map = this.this$0.b;
        return e1.C(map.keySet(), this.this$1.w());
    }
}
