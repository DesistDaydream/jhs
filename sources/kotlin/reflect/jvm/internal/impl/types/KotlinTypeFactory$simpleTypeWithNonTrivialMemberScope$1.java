...
public final class KotlinTypeFactory$simpleTypeWithNonTrivialMemberScope$1 extends Lambda implements l<h, f0> {
    ...
    public KotlinTypeFactory$simpleTypeWithNonTrivialMemberScope$1(q0 q0Var, List<? extends s0> list, e eVar, boolean z, MemberScope memberScope) {
        super(1);
    ...
    public final f0 invoke(@d h hVar) {
        ...
        f0 a = f2.a();
        return a == null ? KotlinTypeFactory.j(this.$annotations, f2.b(), this.$arguments, this.$nullable, this.$memberScope) : a;
    }
}
