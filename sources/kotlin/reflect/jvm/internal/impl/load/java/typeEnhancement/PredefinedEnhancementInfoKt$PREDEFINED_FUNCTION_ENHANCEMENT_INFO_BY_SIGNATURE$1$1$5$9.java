...
public final class PredefinedEnhancementInfoKt$PREDEFINED_FUNCTION_ENHANCEMENT_INFO_BY_SIGNATURE$1$1$5$9 extends Lambda implements l<i.a.C0446a, t1> {
    ...
    public final void invoke2(@d i.a.C0446a c0446a) {
        ...
        eVar2 = PredefinedEnhancementInfoKt.f16555c;
        c0446a.c(str2, eVar2);
        String str3 = this.$JFBiFunction;
        eVar3 = PredefinedEnhancementInfoKt.b;
        eVar4 = PredefinedEnhancementInfoKt.f16555c;
        eVar5 = PredefinedEnhancementInfoKt.f16555c;
        eVar6 = PredefinedEnhancementInfoKt.a;
        c0446a.c(str3, eVar3, eVar4, eVar5, eVar6);
