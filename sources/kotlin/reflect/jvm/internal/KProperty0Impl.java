...
public class KProperty0Impl<V> extends KPropertyImpl<V> implements o<V> {
    ...
    public static final class a<R> extends KPropertyImpl.Getter<R> implements o.a<R> {
        ...
        private final KProperty0Impl<R> f16376h;

        /* JADX WARN: Multi-variable type inference failed */
        public a(@d KProperty0Impl<? extends R> kProperty0Impl) {
            this.f16376h = kProperty0Impl;
        }

        @Override // h.p2.n.a
        @d
        /* renamed from: P */
        public KProperty0Impl<R> d() {
            return this.f16376h;
        }
    ...
    public KProperty0Impl(@d KDeclarationContainerImpl kDeclarationContainerImpl, @d j0 j0Var) {
        super(kDeclarationContainerImpl, j0Var);
        this.f16375m = l.b(new KProperty0Impl$_getter$1(this));
        this.n = z.b(LazyThreadSafetyMode.PUBLICATION, new KProperty0Impl$delegateFieldValue$1(this));
    }
    ...
    public KProperty0Impl(@d KDeclarationContainerImpl kDeclarationContainerImpl, @d String str, @d String str2, @e Object obj) {
