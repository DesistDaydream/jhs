...
public final class KMutableProperty2Impl<D, E, V> extends KProperty2Impl<D, E, V> implements m<D, E, V> {
    private final l.b<a<D, E, V>> o;
    ...
    public static final class a<D, E, V> extends KPropertyImpl.Setter<V> implements m.a<D, E, V> {
        ...
        private final KMutableProperty2Impl<D, E, V> f16360h;

        public a(@d KMutableProperty2Impl<D, E, V> kMutableProperty2Impl) {
            this.f16360h = kMutableProperty2Impl;
        }

        @Override // h.p2.n.a
        @d
        /* renamed from: P */
        public KMutableProperty2Impl<D, E, V> d() {
            return this.f16360h;
        }
    ...
    public KMutableProperty2Impl(@d KDeclarationContainerImpl kDeclarationContainerImpl, @d String str, @d String str2) {
        super(kDeclarationContainerImpl, str, str2);
        this.o = l.b(new KMutableProperty2Impl$_setter$1(this));
    }

    @Override // h.p2.m, h.p2.j
    @d
    /* renamed from: V */
    ...
    public KMutableProperty2Impl(@d KDeclarationContainerImpl kDeclarationContainerImpl, @d j0 j0Var) {
