...
public final class KMutableProperty0Impl<V> extends KProperty0Impl<V> implements k<V> {
    ...
    public static final class a<R> extends KPropertyImpl.Setter<R> implements k.a<R> {
        ...
        private final KMutableProperty0Impl<R> f16358h;

        public a(@d KMutableProperty0Impl<R> kMutableProperty0Impl) {
            this.f16358h = kMutableProperty0Impl;
        }
    ...
    public KMutableProperty0Impl(@d KDeclarationContainerImpl kDeclarationContainerImpl, @d j0 j0Var) {
        super(kDeclarationContainerImpl, j0Var);
        this.o = l.b(new KMutableProperty0Impl$_setter$1(this));
    }

    @Override // h.p2.k, h.p2.j
    @d
    /* renamed from: V */
    ...
    public KMutableProperty0Impl(@d KDeclarationContainerImpl kDeclarationContainerImpl, @d String str, @d String str2, @e Object obj) {
