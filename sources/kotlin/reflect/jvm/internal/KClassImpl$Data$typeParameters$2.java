...
@Metadata(d1 = {"\u0000\u0014\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0000\n\u0000\u0010\u0000\u001a\u0016\u0012\u0004\u0012\u00020\u0002 \u0003*\n\u0012\u0004\u0012\u00020\u0002\u0018\u00010\u00010\u0001\"\b\b\u0000\u0010\u0004*\u00020\u0005H\n¢\u0006\u0002\b\u0006"}, d2 = {"<anonymous>", "", "Lkotlin/reflect/jvm/internal/KTypeParameterImpl;", "kotlin.jvm.PlatformType", ExifInterface.GPS_DIRECTION_TRUE, "", "invoke"}, k = 3, mv = {1, 5, 1})
...
public final class KClassImpl$Data$typeParameters$2 extends Lambda implements a<List<? extends KTypeParameterImpl>> {
    ...
    public final List<? extends KTypeParameterImpl> invoke() {
        List<t0> s = this.this$0.o().s();
        ArrayList arrayList = new ArrayList(u.Y(s, 10));
        for (t0 t0Var : s) {
            arrayList.add(new KTypeParameterImpl(KClassImpl.this, t0Var));
        }
        return arrayList;
    }
}
