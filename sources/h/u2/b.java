...
public abstract class b implements p {
    ...
    public static final class a extends o {
        ...
        @Override // h.u2.o
        public long a() {
            return d.o0(e.i0(this.b.c() - this.a, this.b.b()), this.f15702c);
        }

        @Override // h.u2.o
        @k.e.a.d
        public o e(long j2) {
            return new a(this.a, this.b, d.p0(this.f15702c, j2));
        }
    ...
    public b(@k.e.a.d TimeUnit timeUnit) {
        this.b = timeUnit;
    }
    ...
    @k.e.a.d
    public o a() {
        return new a(c(), this, d.f15705e.g(), null);
    }
