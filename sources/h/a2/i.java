...
public final class i<T> implements Collection<T>, h.k2.v.x0.a {
    @k.e.a.d
    private final T[] a;
    private final boolean b;

    public i(@k.e.a.d T[] tArr, boolean z) {
        this.a = tArr;
        this.b = z;
    }
    ...
    public boolean contains(Object obj) {
        return ArraysKt___ArraysKt.P7(this.a, obj);
    }
