...
public abstract class c<E> extends AbstractCollection<E> implements List<E>, h.k2.v.x0.a {
    @k.e.a.d
    ...
    public static final class a {
        ...
        public final boolean e(@k.e.a.d Collection<?> collection, @k.e.a.d Collection<?> collection2) {
            ...
            while (it2.hasNext()) {
                if (!h.k2.v.f0.g(it2.next(), it.next())) {
                    return false;
                }
            }
            return true;
        ...
        public final int f(@k.e.a.d Collection<?> collection) {
    ...
    /* loaded from: classes3.dex */
    public class b implements Iterator<E>, h.k2.v.x0.a {
        private int a;
    ...
    /* renamed from: h.a2.c$c  reason: collision with other inner class name */
    /* loaded from: classes3.dex */
    public class C0419c extends c<E>.b implements ListIterator<E>, h.k2.v.x0.a {
        public C0419c(int i2) {
            super();
            c.a.c(i2, c.this.size());
            d(i2);
        }
    ...
    public static final class d<E> extends c<E> implements RandomAccess {
        ...
        private final c<E> f14826c;

        /* renamed from: d  reason: collision with root package name */
        private final int f14827d;

        /* JADX WARN: Multi-variable type inference failed */
        public d(@k.e.a.d c<? extends E> cVar, int i2, int i3) {
            this.f14826c = cVar;
            this.f14827d = i2;
            c.a.d(i2, i3, cVar.size());
            this.b = i3 - i2;
        }
        ...
        public E get(int i2) {
            c.a.b(i2, this.b);
            return this.f14826c.get(this.f14827d + i2);
        }
    }
    ...
    public int lastIndexOf(Object obj) {
        ...
        while (listIterator.hasPrevious()) {
            if (h.k2.v.f0.g(listIterator.previous(), obj)) {
