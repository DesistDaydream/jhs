...
public final class c {
    ...
    @k.e.a.d
    public static final <T> T[] e(@k.e.a.d T[] tArr, int i2) {
        T[] tArr2 = (T[]) Arrays.copyOf(tArr, i2);
        Objects.requireNonNull(tArr2, "null cannot be cast to non-null type kotlin.Array<T>");
        return tArr2;
    }

    public static final <E> void f(@k.e.a.d E[] eArr, int i2) {
        eArr[i2] = null;
    }

    public static final <E> void g(@k.e.a.d E[] eArr, int i2, int i3) {
        while (i2 < i3) {
            f(eArr, i2);
            i2++;
        }
    ...
    public static final <T> boolean h(T[] tArr, int i2, int i3, List<?> list) {
        ...
        for (int i4 = 0; i4 < i3; i4++) {
            if (true ^ f0.g(tArr[i2 + i4], list.get(i4))) {
                return false;
            }
        }
        return true;
