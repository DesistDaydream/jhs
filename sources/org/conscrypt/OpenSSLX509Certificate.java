...
public final class OpenSSLX509Certificate extends X509Certificate {
    ...
    public OpenSSLX509Certificate(long j2) throws OpenSSLX509CertificateFactory.ParsingException {
        this.mContext = j2;
            ...
            try {
                ...
                for (int i2 = 0; i2 < d2i_PKCS7_bio.length; i2++) {
                    if (d2i_PKCS7_bio[i2] != 0) {
                        arrayList.add(new OpenSSLX509Certificate(d2i_PKCS7_bio[i2]));
                    }
                }
                return arrayList;
            } catch (Exception e2) {
    ...
    private static Date toDate(long j2) throws OpenSSLX509CertificateFactory.ParsingException {
