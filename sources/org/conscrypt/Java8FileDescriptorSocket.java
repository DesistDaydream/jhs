...
public final class Java8FileDescriptorSocket extends ConscryptFileDescriptorSocket {
    ...
    public Java8FileDescriptorSocket(String str, int i2, SSLParametersImpl sSLParametersImpl) throws IOException {
        super(str, i2, sSLParametersImpl);
    }

    public Java8FileDescriptorSocket(InetAddress inetAddress, int i2, SSLParametersImpl sSLParametersImpl) throws IOException {
        super(inetAddress, i2, sSLParametersImpl);
    }

    public Java8FileDescriptorSocket(String str, int i2, InetAddress inetAddress, int i3, SSLParametersImpl sSLParametersImpl) throws IOException {
        super(str, i2, inetAddress, i3, sSLParametersImpl);
    }

    public Java8FileDescriptorSocket(InetAddress inetAddress, int i2, InetAddress inetAddress2, int i3, SSLParametersImpl sSLParametersImpl) throws IOException {
        super(inetAddress, i2, inetAddress2, i3, sSLParametersImpl);
    }

    public Java8FileDescriptorSocket(Socket socket, String str, int i2, boolean z, SSLParametersImpl sSLParametersImpl) throws IOException {
