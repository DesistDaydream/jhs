...
public final class CacheInterceptor implements Interceptor {
    ...
    public static final class Companion {
        ...
        public final Headers combine(Headers headers, Headers headers2) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if ((!u.K1("Warning", name, true) || !u.u2(value, "1", false, 2, null)) && (isContentSpecificHeader(name) || !isEndToEnd(name) || headers2.get(name) == null)) {
        ...
        private final boolean isContentSpecificHeader(String str) {
            return u.K1("Content-Length", str, true) || u.K1(HttpConnection.CONTENT_ENCODING, str, true) || u.K1("Content-Type", str, true);
        }

        private final boolean isEndToEnd(String str) {
            return (u.K1("Connection", str, true) || u.K1("Keep-Alive", str, true) || u.K1("Proxy-Authenticate", str, true) || u.K1("Proxy-Authorization", str, true) || u.K1("TE", str, true) || u.K1("Trailers", str, true) || u.K1("Transfer-Encoding", str, true) || u.K1("Upgrade", str, true)) ? false : true;
        }
    ...
    private final Response cacheWritingResponse(final CacheRequest cacheRequest, Response response) throws IOException {
        ...
        m0 m0Var = new m0() { // from class: okhttp3.internal.cache.CacheInterceptor$cacheWritingResponse$cacheWritingSource$1
            ...
            public long read(@d m mVar, long j2) throws IOException {
                try {
                    ...
                    mVar.H(c2.getBuffer(), mVar.O0() - read, read);
                    c2.z();
                    return read;
        ...
        return response.newBuilder().body(new RealResponseBody(Response.header$default(response, "Content-Type", null, 2, null), response.body().contentLength(), z.d(m0Var))).build();
    }
