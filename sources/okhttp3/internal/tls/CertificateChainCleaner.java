...
public abstract class CertificateChainCleaner {
    ...
    public static final class Companion {
        ...
        @d
        public final CertificateChainCleaner get(@d X509TrustManager x509TrustManager) {
        ...
        @d
        public final CertificateChainCleaner get(@d X509Certificate... x509CertificateArr) {
    ...
    @d
    public abstract List<Certificate> clean(@d List<? extends Certificate> list, @d String str) throws SSLPeerUnverifiedException;
}
