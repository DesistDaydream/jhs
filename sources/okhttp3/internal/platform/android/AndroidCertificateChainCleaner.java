...
public final class AndroidCertificateChainCleaner extends CertificateChainCleaner {
    ...
    public static final class Companion {
        ...
        @e
        public final AndroidCertificateChainCleaner buildIfSupported(@d X509TrustManager x509TrustManager) {
    ...
    public AndroidCertificateChainCleaner(@d X509TrustManager x509TrustManager, @d X509TrustManagerExtensions x509TrustManagerExtensions) {
    ...
    @SuppressSignatureCheck
    @d
    public List<Certificate> clean(@d List<? extends Certificate> list, @d String str) throws SSLPeerUnverifiedException {
